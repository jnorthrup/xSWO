...
struct sql2003_parser: public grammar<sql2003_parser> {
	...
	struct definition {
		definition(sql2003_parser const& /*self*/) {
		  Query=DirectSQLStatement;;;
		  SQLTerminalCharacter = SQLTerminalCharacter;;;
		  SQLTerminalCharacter = alnum_p		    
		    | SqlSpecialCharacters;;
		  SqlSpecialCharacters = chset_p("\"\%&'()*+,-/:;<^=>? {}_|[]")|'.'
		    | blank_p;;;
		  //SQLSpecialCharacter = chset_p( "\"%&'()*+,-./:;<^=>? {}_|[]")	 ;;;
		  
		  
		  Token = NondelimiterToken | DelimiterToken;;;
		  NondelimiterToken = RegularIdentifier | KeyWord
		    | UnsignedNumericLiteral | NationalCharacterStringLiteral
		    | BinaryStringLiteral | (str_p("0x") >> +(xdigit_p))
		    | LargeObjectLengthToken | Multiplier;;;
		  ...
		  UnicodeDelimitedIdentifier = lexeme_d["U&\""
							>> +UnicodeDelimiterBody >> '"'] >> !(str_p("ESCAPE"))
							>> lex_escape_ch_p;;;
		  ...
		  Unicode4DigitEscapeValue = lexeme_d[lex_escape_ch_p >> xdigit_p
						      >> xdigit_p >> xdigit_p >> xdigit_p];;;
		  Unicode6DigitEscapeValue = lexeme_d[lex_escape_ch_p >> '+'
						      >> xdigit_p >> xdigit_p >> xdigit_p >> xdigit_p >> xdigit_p
						      >> xdigit_p];;;
		  NondoublequoteCharacter = ~(ch_p('"'));;;
		  DoublequoteSymbol = str_p("\"\"");;;
		  DelimiterToken = CharacterStringLiteral | DateString | TimeString
		    | TimestampString | IntervalString | DelimitedIdentifier

		    | UnicodeDelimitedIdentifier | SqlSpecialCharacters
		    | NotEqualsOperator | GreaterThanOrEqualsOperator
		    | LessThanOrEqualsOperator | str_p("||") | str_p("->")
		    //			| LeftBracketTrigraph
		  ...
		  Separator = +(Comment | space_p);;;
		  Comment = SimpleComment | BracketedComment;;;
		  SimpleComment = (SimpleCommentIntroducer >> *CommentCharacter
				   >> eol_p);;;
		  SimpleCommentIntroducer = lexeme_d[ch_p('-') >> +ch_p('-')];;;
		  BracketedComment = BracketedCommentIntroducer
		    >> BracketedCommentContents >> BracketedCommentTerminator;;;
		  BracketedCommentIntroducer =str_p( "/*");;;
		  BracketedCommentTerminator = str_p( "*/");
		  BracketedCommentContents = *((CommentCharacter | Separator));;;
		  CommentCharacter = NonquoteCharacter | ch_p('\'');;;
		  KeyWord = ReservedWord | NonReservedWord;;;
		  NonReservedWord = ch_p('A') | str_p("ABS") | str_p("ABSOLUTE")
		    | str_p("ACTION") | str_p("ADA") | str_p("ADMIN") | str_p(
									      "AFTER") | str_p("ALWAYS") | str_p("ASC") | str_p(
																"ASSERTION") | str_p("ASSIGNMENT") | str_p("ATTRIBUTE")
		    | str_p("ATTRIBUTES") | str_p("AVG") | str_p("BEFORE")
		    | str_p("BERNOULLI") | str_p("BREADTH") | ('C') | str_p(
									    "CARDINALITY") | str_p("CASCADE") | str_p("CATALOG")
		    | str_p("CATALOG_NAME") | str_p("CEIL") | str_p("CEILING")
		    | str_p("CHAIN") | str_p("CHARACTERISTICS") | str_p(
									"CHARACTERS") | str_p("CHARACTER_LENGTH") | str_p(
															  "CHARACTER_SET_CATALOG") | str_p("CHARACTER_SET_NAME")
		    | str_p("CHARACTER_SET_SCHEMA") | str_p("CHAR_LENGTH")
		    | str_p("CHECKED") | str_p("CLASS_ORIGIN") | str_p(
								       "COALESCE") | str_p("COBOL") | str_p("CODE_UNITS") | str_p(
																  "COLLATION") | str_p("COLLATION_CATALOG") | str_p(
																						    "COLLATION_NAME") | str_p("COLLATION_SCHEMA") | str_p(
																													  "COLLECT") | str_p("COLUMN_NAME") | str_p(
																																		    "COMMAND_FUNCTION") | str_p("COMMAND_FUNCTION_CODE")
		    | str_p("COMMITTED") | str_p("CONDITION") | str_p(
								      "CONDITION_NUMBER") | str_p("CONNECTION_NAME") | str_p(
															     "CONSTRAINTS") | str_p("CONSTRAINT_CATALOG") | str_p(
		    ...
		    | str_p("DESCRIPTOR") | str_p("DIAGNOSTICS") | str_p(
									 "DISPATCH") | str_p("DOMAIN") | str_p("DYNAMIC_FUNCTION")
		    | str_p("DYNAMIC_FUNCTION_CODE") | str_p("EQUALS") | str_p(
									       "EVERY") | str_p("EXCEPTION") | str_p("EXCLUDE") | str_p(
																	"EXCLUDING") | str_p("EXP") | str_p("EXTRACT") | str_p(
																							       "FINAL") | str_p("FIRST") | str_p("FLOOR") | str_p(
																														  "FOLLOWING") | str_p("FORTRAN") | str_p("FOUND") | str_p(
																																					   "FUSION") | ('G') | str_p("GENERAL") | str_p("GO") | str_p(
																																												      "GOTO") | str_p("GRANTED") | str_p("HIERARCHY") | str_p(
																																																			      "IMPLEMENTATION") | str_p("INCLUDING") | str_p("INCREMENT")
		    | str_p("INITIALLY") | str_p("INSTANCE") | str_p(
								     "INSTANTIABLE") | str_p("INTERSECTION") | str_p("INVOKER")
		    | str_p("ISOLATION") | ('K') | str_p("KEY") | str_p(
									"KEY_MEMBER") | str_p("KEY_TYPE") | str_p("LAST") | str_p(
																  "LENGTH") | str_p("LEVEL") | str_p("LN") | str_p("LOCATOR")
		    | str_p("LOWER") | ('M') | str_p("MAP") | str_p("MATCHED")
		    | str_p("MAX") | str_p("MAXVALUE")
		    | str_p("MESSAGE_LENGTH") | str_p("MESSAGE_OCTET_LENGTH")
		    | str_p("MESSAGE_TEXT") | str_p("MIN") | str_p("MINVALUE")
		    | str_p("MOD") | str_p("MORE") | str_p("MUMPS") | str_p(
									    "NAME") | str_p("NAMES") | str_p("NESTING") | str_p("NEXT")
		    | str_p("NORMALIZE") | str_p("NORMALIZED") | str_p(
								       "NULLABLE") | str_p("NULLIF") | str_p("NULLS") | str_p(
															      "NUMBER") | str_p("OBJECT") | str_p("OCTETS") | str_p(
																						    "OCTET_LENGTH") | str_p("OPTION") | str_p("OPTIONS")
		    | str_p("ORDERING") | str_p("ORDINALITY") | str_p("OTHERS")
		    | str_p("OVERLAY") | str_p("OVERRIDING") | str_p("PAD")
		    | str_p("PARAMETER_MODE") | str_p("PARAMETER_NAME")
		    | str_p("PARAMETER_ORDINAL_POSITION") | str_p(
								  "PARAMETER_SPECIFIC_CATALOG") | str_p(
													"PARAMETER_SPECIFIC_NAME") | str_p(
																	   "PARAMETER_SPECIFIC_SCHEMA") | str_p("PARTIAL") | str_p(
																								   "PASCAL") | str_p("PATH") | str_p("PERCENTILE_CONT")
		    | str_p("PERCENTILE_DISC") | str_p("PERCENT_RANK") | str_p(
									       "PLACING") | str_p("PLI") | str_p("POSITION") | str_p(
																     "POWER") | str_p("PRECEDING") | str_p("PRESERVE") | str_p(
																							       "PRIOR") | str_p("PRIVILEGES") | str_p("PUBLIC") | str_p(
																															"RANK") | str_p("READ") | str_p("REGR_AVGX") | str_p(
																																					     "REGR_AVGY") | str_p("REGR_COUNT")
		    | str_p("REGR_INTERCEPT") | str_p("REGR_R2") | str_p(
									 "REGR_SLOPE") | str_p("REGR_SXX") | str_p("REGR_SXY")
		    | str_p("REGR_SXY") | str_p("RELATIVE") | str_p(
								    "REPEATABLE") | str_p("RESTART") | str_p("RESULT") | str_p(
															       "RETURNED_CARDINALITY") | str_p("RETURNED_LENGTH") | str_p(
																							  "RETURNED_OCTET_LENGTH") | str_p("RETURNED_SQLSTATE")
		    | str_p("ROLE") | str_p("ROUTINE") | str_p(
							       "ROUTINE_CATALOG") | str_p("ROUTINE_NAME") | str_p(
														  "ROUTINE_SCHEMA") | str_p("ROW_COUNT")
		    | str_p("ROW_NUMBER") | str_p("SCALE") | str_p("SCHEMA")
		    | str_p("SCHEMA_NAME") | str_p("SCOPE_CATALOG") | str_p(
									    "SCOPE_NAME") | str_p("SCOPE_SCHEMA") | str_p("SECTION")
		    | str_p("SECURITY") | str_p("SELF") | str_p("SEQUENCE")
		    | str_p("SERIALIZABLE") | str_p("SERVER_NAME") | str_p(
									   "SESSION") | str_p("SETS") | str_p("SIMPLE")
		    | str_p("SIZE") | str_p("SOURCE") | str_p("SPACE") | str_p(
									       "SPECIFIC_NAME") | str_p("SQRT") | str_p("STATE") | str_p(
																	 "STATEMENT") | str_p("STDDEV_POP") | str_p("STDDEV_SAMP")
		    | str_p("STRUCTURE") | str_p("STYLE") | str_p(
								  "SUBCLASS_ORIGIN") | str_p("SUBSTRING") | str_p("SUM")
		    | str_p("TABLESAMPLE") | str_p("TABLE_NAME") | str_p(
									 "TEMPORARY") | str_p("TIES") | str_p("TOP_LEVEL_COUNT")
		    | str_p("TRANSACTION") | str_p("TRANSACTIONS_COMMITTED")
		    | str_p("TRANSACTIONS_ROLLED_BACK") | str_p(
								"TRANSACTION_ACTIVE") | str_p("TRANSFORM") | str_p(
														   "TRANSFORMS") | str_p("TRANSLATE") | str_p(
																			      "TRIGGER_CATALOG") | str_p("TRIGGER_NAME") | str_p(
																										 "TRIGGER_SCHEMA") | str_p("TRIM") | str_p("TYPE") | str_p(
																																	   "UNBOUNDED") | str_p("UNCOMMITTED") | str_p("UNDER")
		    | str_p("UNNAMED") | str_p("UPPER") | str_p("USAGE")
		    | str_p("USER_DEFINED_TYPE_CATALOG") | str_p(
								 "USER_DEFINED_TYPE_CODE") | str_p("USER_DEFINED_TYPE_NAME")
		    | str_p("USER_DEFINED_TYPE_SCHEMA") | str_p("VAR_POP")
		    | str_p("VAR_SAMP") | str_p("VIEW") | str_p("WIDTH_BUCKET")
		    | str_p("WORK") | str_p("WRITE") | str_p("ZONE");;;
		  ReservedWord = (str_p("ADD")) | str_p("ALL") | str_p("ALLOCATE")
		    | str_p("ALTER") | str_p("AND") | str_p("ANY") | str_p(
									   "ARE") | str_p("ARRAY") | str_p("AS") | str_p("ASENSITIVE")
		    | str_p("ASYMMETRIC") | str_p("AT") | str_p("ATOMIC")
		    | str_p("AUTHORIZATION") | str_p("BEGIN")
		    | str_p("BETWEEN") | str_p("BIGINT") | str_p("BINARY")
		    | str_p("BLOB") | str_p("BOOLEAN") | str_p("BOTH") | str_p(
									       "BY") | str_p("CALL") | str_p("CALLED") | str_p("CASCADED")
		    | str_p("CASE") | str_p("CAST") | str_p("CHAR") | str_p(
									    "CHARACTER") | str_p("CHECK") | str_p("CLOB") | str_p(
																  "CLOSE") | str_p("COLLATE") | str_p("COLUMN") | str_p(
																							"COMMIT") | str_p("CONNECT") | str_p("CONSTRAINT") | str_p(
																														   "CONTINUE") | str_p("CORRESPONDING") | str_p("CREATE")
		    | str_p("CROSS") | str_p("CUBE") | str_p("CURRENT")
		    | str_p("CURRENT_DATE") | str_p(
						    "CURRENT_DEFAULT_TRANSFORM_GROUP") | str_p("CURRENT_PATH")
		    | str_p("CURRENT_ROLE") | str_p("CURRENT_TIME") | str_p(
									    "CURRENT_TIMESTAMP") | str_p(
													 "CURRENT_TRANSFORM_GROUP_FOR_TYPE") | str_p("CURRENT_USER")
		    | str_p("CURSOR") | str_p("CYCLE") | str_p("DATE") | str_p(
									       "DAY") | str_p("DEALLOCATE") | str_p("DEC") | str_p(
																   "DECIMAL") | str_p("DECLARE") | str_p("DEFAULT") | str_p(
																							    "DELETE") | str_p("DEREF") | str_p("DESCRIBE") | str_p(
																														   "DETERMINISTIC") | str_p("DISCONNECT") | str_p("DISTINCT")
		    | str_p("DOUBLE") | str_p("DROP") | str_p("DYNAMIC")
		    | str_p("EACH") | str_p("ELEMENT") | str_p("ELSE") | str_p(
									       "END") | "ENDEXEC" | str_p("ESCAPE") | str_p("EXCEPT")
		    | str_p("EXEC") | str_p("EXECUTE") | str_p("EXISTS")
		    | str_p("EXTERNAL") | str_p("FALSE") | str_p("FETCH")
		    | str_p("FILTER") | str_p("FLOAT") | str_p("FOR") | str_p(
									      "FOREIGN") | str_p("FREE") | str_p("FROM") | str_p("FULL")
		    | str_p("FUNCTION") | str_p("GET") | str_p("GLOBAL")
		    | str_p("GRANT") | str_p("GROUP") | str_p("GROUPING")
		    | str_p("HAVING") | str_p("HOLD") | str_p("HOUR") | str_p(
									      "IDENTITY") | str_p("IMMEDIATE") | str_p("IN") | str_p(
																     "INDICATOR") | str_p("INNER") | str_p("INOUT") | str_p(
																							    "INPUT") | str_p("INSENSITIVE") | str_p("INSERT") | str_p(
																														      "INT") | str_p("INTEGER") | str_p("INTERSECT") | str_p(
																																					     "INTERVAL") | str_p("INTO") | str_p("IS") | str_p(
																																											       "ISOLATION") | str_p("JOIN") | str_p("LANGUAGE") | str_p(
																																																			"LARGE") | str_p("LATERAL") | str_p("LEADING") | str_p(
																																																									       "LEFT") | str_p("LIKE") | str_p("LOCAL") | str_p(
																																																																"LOCALTIME") | str_p("LOCALTIMESTAMP") | str_p("MATCH")
		    | str_p("MEMBER") | str_p("MERGE") | str_p("METHOD")
		    | str_p("MINUTE") | str_p("MODIFIES") | str_p("MODULE")
		    | str_p("MONTH") | str_p("MULTISET") | str_p("NATIONAL")
		    | str_p("NATURAL") | str_p("NCHAR") | str_p("NCLOB")
		    | str_p("NEW") | str_p("NO") | str_p("NONE") | str_p("NOT")
		    | str_p("NULL") | str_p("NUMERIC") | str_p("OF") | str_p(
									     "OLD") | str_p("ON") | str_p("ONLY") | str_p("OPEN")
		    | str_p("OR") | str_p("ORDER") | str_p("OUT") | str_p(
									  "OUTER") | str_p("OUTPUT") | str_p("OVER") | str_p(
															     "OVERLAPS") | str_p("PARAMETER") | str_p("PARTITION")
		    | str_p("PRECISION") | str_p("PREPARE") | str_p("PRIMARY")
		    | str_p("PROCEDURE") | str_p("RANGE") | str_p("READS")
		    | str_p("REAL") | str_p("RECURSIVE") | str_p("REF")
		    | str_p("REFERENCES") | str_p("REFERENCING") | str_p(
									 "RELEASE") | str_p("RETURN") | str_p("RETURNS") | str_p(
																 "REVOKE") | str_p("RIGHT") | str_p("ROLLBACK") | str_p(
																							"ROLLUP") | str_p("ROW") | str_p("ROWS") | str_p(
																													 "SAVEPOINT") | str_p("SCROLL") | str_p("SEARCH") | str_p(
																																				  "SECOND") | str_p("SELECT") | str_p("SENSITIVE") | str_p(
																																											   "SESSION_USER") | str_p("SET") | str_p("SIMILAR") | str_p(
																																																		     "SMALLINT") | str_p("SOME") | str_p("SPECIFIC") | str_p(
																																																									     "SPECIFICTYPE") | str_p("SQL") | str_p("SQLEXCEPTION")
		    | str_p("SQLSTATE") | str_p("SQLWARNING") | str_p("START")
		    | str_p("STATIC") | str_p("SUBMULTISET") | str_p(
								     "SYMMETRIC") | str_p("SYSTEM") | str_p("SYSTEM_USER")
		    | str_p("TABLE") | str_p("THEN") | str_p("TIME") | str_p(
									     "TIMESTAMP") | str_p("TIMEZONE_HOUR") | str_p(
															   "TIMEZONE_MINUTE") | str_p("TO") | str_p("TRAILING")
		    | str_p("TRANSLATION") | str_p("TREAT") | str_p("TRIGGER")
		    | str_p("TRUE") | str_p("UNION") | str_p("UNIQUE") | str_p(
									       "UNKNOWN") | str_p("UNNEST") | str_p("UPDATE") | str_p(
																      "USER") | str_p("USING") | str_p("VALUE") | str_p("VALUES")
		    | str_p("VARCHAR") | str_p("VARYING") | str_p("WHEN")
		    | str_p("WHENEVER") | str_p("WHERE") | str_p("WINDOW")
		    | str_p("WITH") | str_p("WITHIN") | str_p("WITHOUT")
		    | str_p("YEAR");;;
		  ...
		  GeneralLiteral = CharacterStringLiteral
		    ...
		    | UnicodeCharacterStringLiteral | BinaryStringLiteral
		    | DatetimeLiteral | IntervalLiteral | BooleanLiteral;;;
		  CharacterStringLiteral = !(Introducer >> CharacterSetSpecification
					     >> ch_p('\'') >> *CharacterRepresentation >> ch_p('\'')
					     >> *((Separator >> ch_p('\'') >> *CharacterRepresentation
						   >> ch_p('\''))));;;
		  Introducer = ch_p('_');;;
		  CharacterRepresentation = NonquoteCharacter | QuoteSymbol;;;
		  NonquoteCharacter = nothing_p;;;
		  QuoteSymbol = ch_p('\'') >> ch_p('\'');;;
		  NationalCharacterStringLiteral = lexeme_d["N'"
							    >> *CharacterRepresentation >> ch_p('\'') >> *((Separator
													    >> ch_p('\'') >> *CharacterRepresentation >> ch_p('\'')))];;;
		  UnicodeCharacterStringLiteral = !(Introducer
						    >> CharacterSetSpecification >> lexeme_d[str_p("U&'")
											     >> *UnicodeRepresentation >> ch_p('\'') >> *((Separator
																	   >> ch_p('\'') >> *UnicodeRepresentation >> ch_p('\'')))]
						    >> !(str_p("ESCAPE")) >> lex_escape_ch_p);;;
		  UnicodeRepresentation = CharacterRepresentation
		    | UnicodeEscapeValue;;;
		  BinaryStringLiteral = lexeme_d["X" >> ch_p('\'') >> *(xdigit_p
									>> xdigit_p) >> ch_p('\'') >> *((Separator >> ch_p('\'')
													 >> *(xdigit_p >> xdigit_p) >> ch_p('\'')))] >> !str_p(
																			       "ESCAPE") >> lex_escape_ch_p;;;
		  ...
		  TimestampString = ch_p('\'') >> UnquotedTimestampString >> ch_p(
										  '\'');;;
		  TimeZoneInterval = lexeme_d[sign_p >> HoursValue >> ':'
					      >> MinutesValue];;;
		  DateValue = lexeme_d[YearsValue >> '-' >> MonthsValue >> '-'
				       >> DaysValue];;;
		  TimeValue = lexeme_d[HoursValue >> ':' >> MinutesValue >> ':'
				       >> SecondsValue];;;
		  IntervalLiteral = ((str_p("INTERVAL")) >> !sign_p >> IntervalString
				     >> IntervalQualifier);;;
		  IntervalString = ch_p('\'') >> UnquotedIntervalString >> ch_p('\'');;;
		  UnquotedDateString = DateValue;;;
		  UnquotedTimeString = (TimeValue >> !TimeZoneInterval);;;
		  UnquotedTimestampString = UnquotedDateString >> space_p
							       >> UnquotedTimeString;;;
		  UnquotedIntervalString = !(sign_p >> YearMonthLiteral
					     | DayTimeLiteral);;;
		  YearMonthLiteral = lexeme_d[YearsValue | !(YearsValue >> '-'
							     >> MonthsValue)];;;
		  DayTimeLiteral = DayTimeInterval | TimeInterval;;;
		  DayTimeInterval = lexeme_d[(DaysValue >> !(space_p >> HoursValue
							     >> !(ch_p(':') >> MinutesValue >> !ch_p(':')
								  >> SecondsValue)))];;;
		  TimeInterval = lexeme_d[(HoursValue >> !(ch_p(':') >> MinutesValue
							   >> !ch_p(':') >> SecondsValue)) | (MinutesValue >> !ch_p(
		  ...
		  SecondsValue = lexeme_d[(SecondsIntegerValue >> !(ch_p('.')
								    >> !SecondsFraction))];;;
		  ...
		  SQLLanguageIdentifierPart = alpha_p | digit_p;;;
		  ...
		  LocalOrSchemaQualifiedName = !(LocalOrSchemaQualifier >> '.'
						 >> QualifiedIdentifier);;;
		  LocalOrSchemaQualifier = SchemaName | str_p("MODULE");;;
		  ...
		  SchemaQualifiedTypeName = !(SchemaName >> '.'
					      >> QualifiedIdentifier);;;
		  ...
		  ScopeOption = (str_p("GLOBAL")) | str_p("LOCAL");;;
		  WindowName = Identifier;;;
		  DataType = PredefinedType | RowType
		    | PathResolvedUserDefinedTypeName | ReferenceType
		    | CollectionType;;;
		  PredefinedType = (CharacterStringType >> !(str_p("CHARACTER"))
				    >> "SET" >> CharacterSetSpecification >> !CollateClause)
		    | (NationalCharacterStringType >> !CollateClause)
		    | BinaryLargeObjectStringType | NumericType | BooleanType
		    | DatetimeType | IntervalType;;;
		  CharacterStringType = ((str_p("CHARACTER")) >> !ch_p('(') >> Length
		    ...
		    | str_p("VARCHAR") >> '(' >> Length >> ')' | ((str_p(
									 "CHARACTER")) >> "LARGE" >> "OBJECT" >> !ch_p('(')
								  >> LargeObjectLength >> ')') | ((str_p("CHAR")) >> "LARGE"
		  ...
		  ReferenceType = ((str_p("REF")) >> '(' >> ReferencedType >> ')'
				   >> !ScopeClause);;;
		  ...
		  ArrayType = (DataType >> "ARRAY" >> !ch_p('[') >> uint_p >> ch_p(
										   ']'));;;
		  ...
		  NonparenthesizedValueExpressionPrimary = UnsignedValueSpecification
		    ...
		    | WindowFunction | ScalarSubquery | CaseExpression
		    | CastSpecification | FieldReference | SubtypeTreatment
		    | MethodInvocation | StaticMethodInvocation
		    | NewSpecification | AttributeOrMethodReference
		    | ReferenceResolution | CollectionValueConstructor
		    | ArrayElementReference | MultisetElementReference
		    | RoutineInvocation | NextValueExpression;;;
		  ...
		  GeneralValueSpecification = HostParameterSpecification
		    | SQLParameterReference | DynamicParameterSpecification
		    | EmbeddedVariableSpecification
		    | CurrentCollationSpecification | str_p(
							    "CURRENT_DEFAULT_TRANSFORM_GROUP") | str_p("CURRENT_PATH")
		    | str_p("CURRENT_ROLE") | str_p(
						    "CURRENT_TRANSFORM_GROUP_FOR_TYPE")
		    >> PathResolvedUserDefinedTypeName | str_p("CURRENT_USER")
		    | str_p("SESSION_USER") | str_p("SYSTEM_USER") | str_p(
									   "USER") | str_p("VALUE");;;
		  SimpleValueSpecification = Literal | HostParameterName
		    | SQLParameterReference | EmbeddedVariableName;;;
		  TargetSpecification = HostParameterSpecification
		    | SQLParameterReference | ColumnReference
		  ...
		  HostParameterSpecification = (HostParameterName
						>> !IndicatorParameter);;;
		  DynamicParameterSpecification = ch_p('?');;;
		  EmbeddedVariableSpecification = (EmbeddedVariableName
						   >> !IndicatorVariable);;;
		  IndicatorVariable = !((str_p("INDICATOR")) >> EmbeddedVariableName);;;
		  IndicatorParameter = !((str_p("INDICATOR")) >> HostParameterName);;;
		  TargetArrayElementSpecification = TargetArrayReference >> ch_p('[')
									 >> SimpleValueSpecification >> ch_p(']');;;
		  TargetArrayReference = SQLParameterReference | ColumnReference;;;
		  CurrentCollationSpecification = (str_p("CURRENT_COLLATION")) >> '('
		  ...
		  ColumnReference = BasicIdentifierChain | str_p("MODULE") >> '.'
									   >> QualifiedIdentifier >> '.' >> ColumnName;;;
		  SQLParameterReference = BasicIdentifierChain;;;
		  SetFunctionSpecification = AggregateFunction | GroupingOperation;;;
		  GroupingOperation = ((str_p("GROUPING")) >> '(' >> (ColumnReference
								      % ch_p(',')) >> ')');;;
		  WindowFunction = WindowFunctionType >> "OVER"
						      >> WindowNameOrSpecification;;;
		  WindowFunctionType = RankFunctionType >> '(' >> ')' | str_p(
									      "ROW_NUMBER") >> '(' >> ')' | AggregateFunction;;;
		  RankFunctionType = (str_p("RANK")) | str_p("DENSE_RANK") | str_p(
										   "PERCENT_RANK") | str_p("CUME_DIST");;;
		  ...
		  CaseAbbreviation = (str_p("NULLIF")) >> '(' >> ValueExpression
						       >> ',' >> ValueExpression >> ')' | ((str_p("COALESCE"))
											   >> '(' >> ValueExpression >> +ch_p(',') >> ValueExpression
											   >> ')');;;
		  CaseSpecification = SimpleCase | SearchedCase;;;
		  SimpleCase = ((str_p("CASE")) >> CaseOperand >> +SimpleWhenClause
				>> !ElseClause >> "END");;;
		  SearchedCase = ((str_p("CASE")) >> +SearchedWhenClause
				  >> !ElseClause >> "END");;;
		  SimpleWhenClause = (str_p("WHEN")) >> WhenOperand >> "THEN"
						     >> Result;;;
		  SearchedWhenClause = (str_p("WHEN")) >> SearchCondition >> "THEN"
						       >> Result;;;
		  ...
		  WhenOperand = RowValuePredicand | ComparisonPredicatePart2
		    | BetweenPredicatePart2 | InPredicatePart2
		    | CharacterLikePredicatePart2 | OctetLikePredicatePart2
		    | SimilarPredicatePart2 | NullPredicatePart2
		    | QuantifiedComparisonPredicatePart2 | MatchPredicatePart2
		    | OverlapsPredicatePart2 | DistinctPredicatePart2
		    | MemberPredicatePart2 | SubmultisetPredicatePart2
		    | SetPredicatePart2 | TypePredicatePart2;;;
		  Result = ResultExpression | str_p("NULL");;;
		  ResultExpression = ValueExpression;;;
		  CastSpecification = (str_p("CAST")) >> '(' >> CastOperand >> "AS"
						      >> CastTarget >> ')';;;
		  CastOperand = ValueExpression | ImplicitlyTypedValueSpecification;;;
		  CastTarget = DomainName | DataType;;;
		  NextValueExpression = (str_p("NEXT")) >> "VALUE" >> "FOR"
							>> SequenceGeneratorName;;;
		  FieldReference = ValueExpressionPrimary >> '.' >> FieldName;;;
		  SubtypeTreatment = (str_p("TREAT")) >> '(' >> SubtypeOperand
						      >> "AS" >> TargetSubtype >> ')';;;
		  ...
		  DirectInvocation = (ValueExpressionPrimary >> '.' >> MethodName
				      >> !SQLArgumentList);;;
		  GeneralizedInvocation = (ch_p('(') >> ValueExpressionPrimary
					   >> "AS" >> DataType >> ')' >> '.' >> MethodName
					   >> !SQLArgumentList);;;
		  MethodSelection = RoutineInvocation;;;
		  ConstructorMethodSelection = RoutineInvocation;;;
		  StaticMethodInvocation = (PathResolvedUserDefinedTypeName >> "::"
					    >> MethodName >> !SQLArgumentList);;;
		  ...
		  AttributeOrMethodReference = (ValueExpressionPrimary
						>> DereferenceOperator >> QualifiedIdentifier
						>> !SQLArgumentList);;;
		  DereferenceOperator =str_p( "->");;;
		  DereferenceOperation = ReferenceValueExpression
		    >> DereferenceOperator >> AttributeName;;;
		  MethodReference = ValueExpressionPrimary >> DereferenceOperator
							   >> MethodName >> SQLArgumentList;;;
		  ReferenceResolution = (str_p("DEREF")) >> '('
							 >> ReferenceValueExpression >> ')';;;
		  ArrayElementReference = ArrayValueExpression >> ch_p('[')
							       >> NumericValueExpression >> ch_p(']');;;
		  MultisetElementReference = (str_p("ELEMENT")) >> '('
		  ...
		  CommonValueExpression = NumericValueExpression
		    | StringValueExpression | DatetimeValueExpression
		    | IntervalValueExpression | UserDefinedTypeValueExpression
		  ...
		  Factor = !(sign_p >> NumericPrimary);;;
		  NumericPrimary = ValueExpressionPrimary | NumericValueFunction;;;
		  NumericValueFunction = PositionExpression | ExtractExpression
		    | LengthExpression | CardinalityExpression
		    | AbsoluteValueExpression | ModulusExpression
		    | NaturalLogarithm | ExponentialFunction | PowerFunction
		    | SquareRoot | FloorFunction | CeilingFunction
		    | WidthBucketFunction;;;
		  PositionExpression = StringPositionExpression
		    | BlobPositionExpression;;;
		  StringPositionExpression = ((str_p("POSITION")) >> '('
					      >> StringValueExpression >> "IN" >> StringValueExpression
					      >> !(str_p("USING")) >> CharLengthUnits >> ')');;;
		  BlobPositionExpression = (str_p("POSITION")) >> '('
							       >> BlobValueExpression >> "IN" >> BlobValueExpression
							       >> ')';;;
		  LengthExpression = CharLengthExpression | OctetLengthExpression;;;
		  CharLengthExpression = ((str_p("CHAR_LENGTH")) | str_p(
									 "CHARACTER_LENGTH") >> '(' >> StringValueExpression
					  >> !(str_p("USING")) >> CharLengthUnits >> ')');;;
		  OctetLengthExpression = (str_p("OCTET_LENGTH")) >> '('
								  >> StringValueExpression >> ')';;;
		  ExtractExpression = (str_p("EXTRACT")) >> '(' >> ExtractField
							 >> "FROM" >> ExtractSource >> ')';;;
		  ExtractField = PrimaryDatetimeField | TimeZoneField;;;
		  TimeZoneField = (str_p("TIMEZONE_HOUR")) | str_p("TIMEZONE_MINUTE");;;
		  ExtractSource = DatetimeValueExpression | IntervalValueExpression;;;
		  CardinalityExpression = (str_p("CARDINALITY")) >> '('
								 >> CollectionValueExpression >> ')';;;
		  AbsoluteValueExpression = (str_p("ABS")) >> '('
							   >> NumericValueExpression >> ')';;;
		  ModulusExpression = (str_p("MOD")) >> '(' >> NumericValueExpression
						     >> ',' >> NumericValueExpression >> ')';;;
		  NaturalLogarithm = (str_p("LN")) >> '(' >> NumericValueExpression
						   >> ')';;;
		  ExponentialFunction = (str_p("EXP")) >> '('
						       >> NumericValueExpression >> ')';;;
		  PowerFunction = (str_p("POWER")) >> '('
		  ...
		  FloorFunction = (str_p("FLOOR")) >> '(' >> NumericValueExpression
						   >> ')';;;
		  CeilingFunction = ((str_p("CEIL")) | str_p("CEILING") >> '('
				     >> NumericValueExpression >> ')');;;
		  WidthBucketFunction = (str_p("WIDTH_BUCKET")) >> '('
								>> WidthBucketOperand >> ',' >> WidthBucketBound1 >> ','
								>> WidthBucketBound2 >> ',' >> WidthBucketCount >> ')';;;
		  ...
		  Concatenation = CharacterValueExpression >> str_p("||")
							   >> CharacterFactor;;;
		  ...
		  BlobConcatenation = BlobValueExpression >> str_p("||")
							  >> BlobFactor;;;
		  StringValueFunction = CharacterValueFunction | BlobValueFunction;;;
		  CharacterValueFunction = CharacterSubstringFunction
		    | RegularExpressionSubstringFunction | Fold | Transcoding
		    | CharacterTransliteration | TrimFunction
		    | CharacterOverlayFunction | NormalizeFunction
		    | SpecificTypeMethod;;;
		  CharacterSubstringFunction = ((str_p("SUBSTRING")) >> '('
						>> CharacterValueExpression >> "FROM" >> StartPosition
						>> !(str_p("FOR")) >> StringLength >> !(str_p("USING"))
						>> CharLengthUnits >> ')');;;
		  RegularExpressionSubstringFunction = (str_p("SUBSTRING")) >> '('
									    >> CharacterValueExpression >> "SIMILAR"
									    >> CharacterValueExpression >> "ESCAPE" >> lex_escape_ch_p
									    >> ')';;;
		  Fold = ((str_p("UPPER")) | str_p("LOWER") >> '('
			  >> CharacterValueExpression >> ')');;;
		  Transcoding = (str_p("CONVERT")) >> '(' >> CharacterValueExpression
						   >> "USING" >> TranscodingName >> ')';;;
		  CharacterTransliteration = (str_p("TRANSLATE")) >> '('
								  >> CharacterValueExpression >> "USING"
								  >> TransliterationName >> ')';;;
		  TrimFunction = (str_p("TRIM")) >> '(' >> TrimOperands >> ')';;;
		  TrimOperands = !(!(TrimSpecification >> !TrimCharacter >> "FROM")
				   >> TrimSource);;;
		  TrimSource = CharacterValueExpression;;;
		  TrimSpecification = (str_p("LEADING")) | str_p("TRAILING") | str_p(
										     "BOTH");;;
		  TrimCharacter = CharacterValueExpression;;;
		  CharacterOverlayFunction = ((str_p("OVERLAY")) >> '('
					      >> CharacterValueExpression >> "PLACING"
					      >> CharacterValueExpression >> "FROM" >> StartPosition
					      >> !(str_p("FOR")) >> StringLength >> !(str_p("USING"))
					      >> CharLengthUnits >> ')');;;
		  NormalizeFunction = (str_p("NORMALIZE")) >> '('
							   >> CharacterValueExpression >> ')';;;
		  SpecificTypeMethod = UserDefinedTypeValueExpression >> '.'
								      >> "SPECIFICTYPE";;;
		  BlobValueFunction = BlobSubstringFunction | BlobTrimFunction
		    | BlobOverlayFunction;;;
		  BlobSubstringFunction = ((str_p("SUBSTRING")) >> '('
					   >> BlobValueExpression >> "FROM" >> StartPosition
					   >> !(str_p("FOR")) >> StringLength >> ')');;;
		  BlobTrimFunction = (str_p("TRIM")) >> '(' >> BlobTrimOperands
						     >> ')';;;
		  BlobTrimOperands = !(!(TrimSpecification >> !TrimOctet >> "FROM")
				       >> BlobTrimSource);;;
		  BlobTrimSource = BlobValueExpression;;;
		  TrimOctet = BlobValueExpression;;;
		  BlobOverlayFunction = ((str_p("OVERLAY")) >> '('
					 >> BlobValueExpression >> "PLACING" >> BlobValueExpression
					 >> "FROM" >> StartPosition >> !(str_p("FOR"))
					 >> StringLength >> ')');;;
		  StartPosition = NumericValueExpression;;;
		  StringLength = NumericValueExpression;;;
		  DatetimeValueExpression = DatetimeTerm | IntervalValueExpression
		    >> '+' >> DatetimeTerm | DatetimeValueExpression >> '+'
		    >> IntervalTerm | DatetimeValueExpression >> '-'
		    >> IntervalTerm;;;
		  ...
		  TimeZoneSpecifier = (str_p("LOCAL")) | str_p("TIME") >> "ZONE"
								       >> IntervalPrimary;;;
		  DatetimeValueFunction = CurrentDateValueFunction
		    | CurrentTimeValueFunction | CurrentTimestampValueFunction
		    | CurrentLocalTimeValueFunction
		    | CurrentLocalTimestampValueFunction;;;
		  CurrentDateValueFunction = (str_p("CURRENT_DATE"));;;
		  CurrentTimeValueFunction = ((str_p("CURRENT_TIME")) >> !ch_p('(')
					      >> TimePrecision >> ')');;;
		  CurrentLocalTimeValueFunction = ((str_p("LOCALTIME")) >> !ch_p('(')
						   >> TimePrecision >> ')');;;
		  CurrentTimestampValueFunction = ((str_p("CURRENT_TIMESTAMP"))
						   >> !ch_p('(') >> TimestampPrecision >> ')');;;
		  CurrentLocalTimestampValueFunction = ((str_p("LOCALTIMESTAMP"))
							>> !ch_p('(') >> TimestampPrecision >> ')');;;
		  IntervalValueExpression = IntervalTerm | IntervalValueExpression1
		    >> '+' >> IntervalTerm1 | IntervalValueExpression1 >> '-'
		    >> IntervalTerm1 | '(' >> DatetimeValueExpression >> '-'
		    >> DatetimeTerm >> ')' >> IntervalQualifier;;;
		  IntervalTerm = IntervalFactor | IntervalTerm2 >> '*' >> Factor
		    | IntervalTerm2 >> '/' >> Factor | Term >> '*'
								>> IntervalFactor;;;
		  ...
		  IntervalAbsoluteValueFunction = (str_p("ABS")) >> '('
								 >> IntervalValueExpression >> ')';;;
		  BooleanValueExpression = BooleanTerm | BooleanValueExpression
		    >> "OR" >> BooleanTerm;;;
		  BooleanTerm = BooleanFactor | BooleanTerm >> "AND" >> BooleanFactor;;;
		  BooleanFactor = !((str_p("NOT")) >> BooleanTest);;;
		  BooleanTest = (BooleanPrimary >> !((str_p("IS")) >> !(str_p("NOT"))
						     >> TruthValue));;;
		  TruthValue = (str_p("TRUE")) | str_p("FALSE") | str_p("UNKNOWN");;;
		  BooleanPrimary = Predicate | BooleanPredicand;;;
		  BooleanPredicand = ParenthesizedBooleanValueExpression
		    | NonparenthesizedValueExpressionPrimary;;;
		  ParenthesizedBooleanValueExpression = ch_p('(')
		    >> BooleanValueExpression >> ')';;;
		  ArrayValueExpression = ArrayConcatenation | ArrayFactor;;;
		  ArrayConcatenation = ArrayValueExpression1 >> str_p("||")
							     >> ArrayFactor;;;
		  ...
		  ArrayValueConstructorByEnumeration = (str_p("ARRAY")) >> ch_p('[')
									>> ArrayElementList >> ch_p(']');;;
		  ArrayElementList = ((ArrayElement % ch_p(',')));;;
		  ArrayElement = ValueExpression;;;
		  ArrayValueConstructorByQuery = ((str_p("ARRAY")) >> '('
						  >> QueryExpression >> !OrderByClause >> ')');;;
		  MultisetValueExpression = MultisetTerm | (MultisetValueExpression
							    >> "MULTISET" >> "UNION" >> !(str_p("ALL")) | str_p(
														"DISTINCT") >> MultisetTerm) | (MultisetValueExpression
																		>> "MULTISET" >> "EXCEPT" >> !(str_p("ALL")) | str_p(
																								     "DISTINCT") >> MultisetTerm);;;
		  MultisetTerm = MultisetPrimary | (MultisetTerm >> "MULTISET"
						    >> "INTERSECT" >> !(str_p("ALL")) | str_p("DISTINCT")
						    >> MultisetPrimary);;;
		  MultisetPrimary = MultisetValueFunction | ValueExpressionPrimary;;;
		  MultisetValueFunction = MultisetSetFunction;;;
		  MultisetSetFunction = (str_p("SET")) >> '('
						       >> MultisetValueExpression >> ')';;;
		  ...
		  MultisetValueConstructorByEnumeration = (str_p("MULTISET"))
		    >> ch_p('[') >> MultisetElementList >> ch_p(']');;;
		  MultisetElementList = (MultisetElement >> !(ch_p(',')
							      >> MultisetElement));;;
		  MultisetElement = ValueExpression;;;
		  MultisetValueConstructorByQuery = (str_p("MULTISET")) >> '('
									>> QueryExpression >> ')';;;
		  TableValueConstructorByQuery = (str_p("TABLE")) >> '('
								  >> QueryExpression >> ')';;;// >> Specify >> A >> Value >> Or >> List >> Of >> Values >> To >> Be >> Constructed >> Into >> A >> Row >> Or >> Partial >> Row.;;;
		  RowValueConstructor = CommonValueExpression
		    | BooleanValueExpression | ExplicitRowValueConstructor;;;
		  ExplicitRowValueConstructor = ch_p('(')
		    >> RowValueConstructorElement >> ','
		    >> RowValueConstructorElementList >> ')' | str_p("ROW")
		  ...
		  ContextuallyTypedTableValueConstructor = (str_p("VALUES"))
		    >> ContextuallyTypedRowValueExpressionList;;;
		  ContextuallyTypedRowValueExpressionList
		    = ((ContextuallyTypedRowValueExpression % ch_p(',')));;;
		  ...
		  SampleClause = ((str_p("TABLESAMPLE")) >> SampleMethod >> '('
				  >> SamplePercentage >> ')' >> !RepeatableClause);;;
		  SampleMethod = (str_p("BERNOULLI")) | str_p("SYSTEM");;;
		  ...
		  TablePrimary = (TableOrQueryName >> !!((str_p("AS"))
							 >> CorrelationName >> !ch_p('(') >> DerivedColumnList
							 >> ')')) | (DerivedTable >> !(str_p("AS"))
								     >> CorrelationName >> !ch_p('(') >> DerivedColumnList
								     >> ')') | (LateralDerivedTable >> !(str_p("AS"))
										>> CorrelationName >> !ch_p('(') >> DerivedColumnList
										>> ')') | (CollectionDerivedTable >> !(str_p("AS"))
											   >> CorrelationName >> !ch_p('(') >> DerivedColumnList
											   >> ')') | (TableFunctionDerivedTable >> !(str_p("AS"))
												      >> CorrelationName >> !ch_p('(') >> DerivedColumnList
												      >> ')') | (OnlySpec >> !!((str_p("AS")) >> CorrelationName
																>> !ch_p('(') >> DerivedColumnList >> ')')) | '('
		    >> JoinedTable >> ')';;;
		  OnlySpec = (str_p("ONLY")) >> '(' >> TableOrQueryName >> ')';;;
		  LateralDerivedTable = (str_p("LATERAL")) >> TableSubquery;;;
		  CollectionDerivedTable = ((str_p("UNNEST")) >> '('
					    >> CollectionValueExpression >> ')' >> !(str_p("WITH"))
					    >> "ORDINALITY");;;
		  TableFunctionDerivedTable = (str_p("TABLE")) >> '('
							       >> CollectionValueExpression >> ')';;;
		  ...
		  NaturalJoin = (TableReference >> "NATURAL" >> !JoinType >> "JOIN"
				 >> TablePrimary);;;
		  ...
		  OuterJoinType = (str_p("LEFT")) | str_p("RIGHT") | str_p("FULL");;;
		  JoinColumnList = ColumnNameList;;;
		  WhereClause = (str_p("WHERE")) >> SearchCondition;;;
		  GroupByClause = ((str_p("GROUP")) >> "BY" >> !SetQuantifier
				   >> GroupingElementList);;;
		  GroupingElementList = ((GroupingElement % ch_p(',')));;;
		  GroupingElement = OrdinaryGroupingSet | RollupList | CubeList
		    | GroupingSetsSpecification | EmptyGroupingSet;;;
		  ...
		  GroupingSetsSpecification = (str_p("GROUPING")) >> "SETS" >> '('
								  >> GroupingSetList >> ')';;;
		  GroupingSetList = ((GroupingSet % ch_p(',')));;;
		  GroupingSet = OrdinaryGroupingSet | RollupList | CubeList
		    | GroupingSetsSpecification | EmptyGroupingSet;;;
		  ...
		  AllFieldsReference = (ValueExpressionPrimary >> '.' >> '*'
					>> !(str_p("AS")) >> '(' >> AllFieldsColumnNameList >> ')');;;
		  ...
		  WithListElement = (QueryName >> !ch_p('(') >> WithColumnList >> ')'
				     >> "AS" >> '(' >> QueryExpression >> ')'
				     >> !SearchOrCycleClause);;;
		  WithColumnList = ColumnNameList;;;
		  QueryExpressionBody = NonJoinQueryExpression | JoinedTable;;;
		  NonJoinQueryExpression = NonJoinQueryTerm | (QueryExpressionBody
							       >> "UNION" >> !(str_p("ALL")) | str_p("DISTINCT")
							       >> !CorrespondingSpec >> QueryTerm) | (QueryExpressionBody
												      >> "EXCEPT" >> !(str_p("ALL")) | str_p("DISTINCT")
												      >> !CorrespondingSpec >> QueryTerm);;;
		  QueryTerm = NonJoinQueryTerm | JoinedTable;;;
		  NonJoinQueryTerm = NonJoinQueryPrimary | (QueryTerm >> "INTERSECT"
							    >> !(str_p("ALL")) | str_p("DISTINCT")
							    >> !CorrespondingSpec >> QueryPrimary);;;
		  QueryPrimary = NonJoinQueryPrimary | JoinedTable;;;
		  NonJoinQueryPrimary = SimpleTable | '(' >> NonJoinQueryExpression
							  >> ')';;;
		  SimpleTable = QuerySpecification | TableValueConstructor
		    | ExplicitTable;;;
		  ExplicitTable = (str_p("TABLE")) >> TableOrQueryName;;;
		  CorrespondingSpec = ((str_p("CORRESPONDING")) >> !(str_p("BY"))
				       >> '(' >> CorrespondingColumnList >> ')');;;
		  CorrespondingColumnList = ColumnNameList;;;
		  SearchOrCycleClause = SearchClause | CycleClause | SearchClause
		    >> CycleClause;;;
		  SearchClause = (str_p("SEARCH")) >> RecursiveSearchOrder >> "SET"
						   >> SequenceColumn;;;
		  RecursiveSearchOrder = (str_p("DEPTH")) >> "FIRST" >> "BY"
							  >> SortSpecificationList | str_p("BREADTH") >> "FIRST"
							  >> "BY" >> SortSpecificationList;;;
		  SequenceColumn = ColumnName;;;
		  CycleClause = (str_p("CYCLE")) >> CycleColumnList >> "SET"
						 >> CycleMarkColumn >> "TO" >> CycleMarkValue >> "DEFAULT"
						 >> NonCycleMarkValue >> "USING" >> PathColumn;;;
		  ...
		  Predicate = ComparisonPredicate | BetweenPredicate | InPredicate
		    | LikePredicate | SimilarPredicate | NullPredicate
		    | QuantifiedComparisonPredicate | ExistsPredicate
		    | UniquePredicate | NormalizedPredicate | MatchPredicate
		    | OverlapsPredicate | DistinctPredicate | MemberPredicate
		    | SubmultisetPredicate | SetPredicate | TypePredicate;;;
		  ComparisonPredicate = RowValuePredicand >> ComparisonPredicatePart2;;;
		  ComparisonPredicatePart2 = CompOp >> RowValuePredicand;;;
		  CompOp = ch_p('=') | NotEqualsOperator | '<' | '>'
		    | LessThanOrEqualsOperator | GreaterThanOrEqualsOperator;;;
		  BetweenPredicate = RowValuePredicand >> BetweenPredicatePart2;;;
		  BetweenPredicatePart2 = !((str_p("NOT")) >> "BETWEEN" >> !(str_p(
										   "ASYMMETRIC")) | str_p("SYMMETRIC") >> RowValuePredicand
					    >> "AND" >> RowValuePredicand);;;
		  InPredicate = RowValuePredicand >> InPredicatePart2;;;
		  InPredicatePart2 = !((str_p("NOT")) >> "IN" >> InPredicateValue);;;
		  InPredicateValue = TableSubquery | '(' >> InValueList >> ')';;;
		  InValueList = RowValueExpression % ch_p(',');;;
		  LikePredicate = CharacterLikePredicate | OctetLikePredicate;;;
		  CharacterLikePredicate = RowValuePredicand
		    >> CharacterLikePredicatePart2;;;
		  CharacterLikePredicatePart2 = !str_p("NOT") >> "LIKE"
							      >> CharacterPattern;;;//>> !(str_p("ESCAPE")) >> lex_escape_ch_p		;;;
		  ...
		  SimilarPredicatePart2 = !(str_p("NOT") >> "SIMILAR" >> "TO"
					    >> SimilarPattern);;;//>> !(str_p("ESCAPE")) >> lex_escape_ch_p		;;;
		  SimilarPattern = CharacterValueExpression;;;
		  RegularExpression = RegularTerm | RegularExpression >> '|'
								      >> RegularTerm;;;
		  RegularTerm = RegularFactor | RegularTerm >> RegularFactor;;;
		  RegularFactor = RegularPrimary | RegularPrimary >> '*'
		  ...
		  CharacterEnumeration = CharacterSpecifier | CharacterSpecifier
		    >> '-' >> CharacterSpecifier | ch_p('{') >> ':'
		  ...
		  QuantifiedComparisonPredicate = RowValuePredicand
		    >> QuantifiedComparisonPredicatePart2;;;
		  QuantifiedComparisonPredicatePart2 = CompOp >> Quantifier
							      >> TableSubquery;;;
		  Quantifier = All | Some;;;
		  All = (str_p("ALL"));;;
		  Some = (str_p("SOME")) | str_p("ANY");;;
		  ExistsPredicate = (str_p("EXISTS")) >> TableSubquery;;;
		  UniquePredicate = (str_p("UNIQUE")) >> TableSubquery;;;
		  NormalizedPredicate = (StringValueExpression >> "IS" >> !(str_p(
										  "NOT")) >> "NORMALIZED");;;
		  MatchPredicate = RowValuePredicand >> MatchPredicatePart2;;;
		  MatchPredicatePart2 = ((str_p("MATCH")) >> !(str_p("UNIQUE"))
					 >> !(str_p("SIMPLE")) | str_p("PARTIAL") | str_p("FULL")
					 >> TableSubquery);;;
		  OverlapsPredicate = OverlapsPredicatePart1
		  ...
		  DistinctPredicatePart2 = (str_p("IS")) >> "DISTINCT" >> "FROM"
							 >> RowValuePredicand4;;;
		  ...
		  MemberPredicatePart2 = !((str_p("NOT")) >> "MEMBER"
					   >> !(str_p("OF")) >> MultisetValueExpression);;;
		  SubmultisetPredicate = RowValuePredicand
		    >> SubmultisetPredicatePart2;;;
		  SubmultisetPredicatePart2 = !((str_p("NOT")) >> "SUBMULTISET"
						>> !(str_p("OF")) >> MultisetValueExpression);;;
		  SetPredicate = RowValuePredicand >> SetPredicatePart2;;;
		  SetPredicatePart2 = ((str_p("IS")) >> !(str_p("NOT")) >> "A"
				       >> "SET");;;
		  TypePredicate = RowValuePredicand >> TypePredicatePart2;;;
		  TypePredicatePart2 = ((str_p("IS")) >> !(str_p("NOT")) >> "OF"
					>> '(' >> TypeList >> ')');;;
		  ...
		  ExclusiveUserDefinedTypeSpecification = (str_p("ONLY"))
		    >> PathResolvedUserDefinedTypeName;;;
		  SearchCondition = BooleanValueExpression;;;
		  IntervalQualifier = StartField >> "TO" >> EndField
		    | SingleDatetimeField;;;
		  StartField = (NonSecondPrimaryDatetimeField >> !ch_p('(')
				>> IntervalLeadingFieldPrecision >> ')');;;
		  EndField = NonSecondPrimaryDatetimeField | ((str_p("SECOND"))
							      >> !ch_p('(') >> IntervalFractionalSecondsPrecision >> ')');;;
		  SingleDatetimeField = (NonSecondPrimaryDatetimeField >> !ch_p('(')
					 >> IntervalLeadingFieldPrecision >> ')')
		    | ((str_p("SECOND")) >> !(ch_p('(')
					      >> IntervalLeadingFieldPrecision >> !ch_p(',')
					      >> IntervalFractionalSecondsPrecision >> ')'));;;
		  PrimaryDatetimeField = NonSecondPrimaryDatetimeField | str_p(
									       "SECOND");;;
		  NonSecondPrimaryDatetimeField = (str_p("YEAR")) | str_p("MONTH")
		    | str_p("DAY") | str_p("HOUR") | str_p("MINUTE");;;
		  IntervalFractionalSecondsPrecision = uint_p;;;
		  IntervalLeadingFieldPrecision = uint_p;;;
		  LanguageClause = (str_p("LANGUAGE")) >> LanguageName;;;
		  LanguageName = (str_p("ADA")) | ('C') | str_p("COBOL") | str_p(
										 "FORTRAN") | str_p("MUMPS") | str_p("PASCAL")
		    | str_p("PLI") | str_p("SQL");;;
		  ...
		  SQLArgumentList
		    = (ch_p('(') >> !((SQLArgument % ch_p(','))) >> ')');;;
		  SQLArgument = ValueExpression | GeneralizedExpression
		    | TargetSpecification;;;
		  GeneralizedExpression = ValueExpression >> "AS"
							  >> PathResolvedUserDefinedTypeName;;;
		  ...
		  SpecificRoutineDesignator = (str_p("SPECIFIC")) >> RoutineType
								  >> SpecificName | (RoutineType >> MemberName >> !(str_p(
															  "FOR")) >> SchemaResolvedUserDefinedTypeName);;;
		  RoutineType = str_p("ROUTINE") | str_p("FUNCTION") | str_p(
									     "PROCEDURE") | !((str_p("INSTANCE")) | str_p("STATIC")
		  ...
		  ConstraintCharacteristics = (ConstraintCheckTime
					       >> !!((str_p("NOT")) >> "DEFERRABLE")) | !((str_p("NOT"))
											  >> "DEFERRABLE" >> !ConstraintCheckTime);;;
		  ConstraintCheckTime = (str_p("INITIALLY")) >> "DEFERRED" | str_p(
										   "INITIALLY") >> "IMMEDIATE";;;
		  AggregateFunction = ((str_p("COUNT")) >> '(' >> '*' >> ')'
				       >> !FilterClause) | (GeneralSetFunction >> !FilterClause)
		    | (BinarySetFunction >> !FilterClause)
		    | (OrderedSetFunction >> !FilterClause);;;
		  GeneralSetFunction = (SetFunctionType >> '(' >> !SetQuantifier
					>> ValueExpression >> ')');;;
		  SetFunctionType = ComputationalOperation;;;
		  ComputationalOperation = (str_p("AVG")) | str_p("MAX") | str_p(
										 "MIN") | str_p("SUM") | str_p("EVERY") | str_p("ANY")
		    | str_p("SOME") | str_p("COUNT") | str_p("STDDEV_POP")
		    | str_p("STDDEV_SAMP") | str_p("VAR_SAMP") | str_p(
								       "VAR_POP") | str_p("COLLECT") | str_p("FUSION") | str_p(
															       "INTERSECTION");;;
		  SetQuantifier = (str_p("DISTINCT")) | str_p("ALL");;;
		  FilterClause = (str_p("FILTER")) >> '(' >> "WHERE"
						   >> SearchCondition >> ')';;;
		  BinarySetFunction = BinarySetFunctionType >> '('
							    >> DependentVariableExpression >> ','
							    >> IndependentVariableExpression >> ')';;;
		  BinarySetFunctionType = (str_p("COVAR_POP")) | str_p("COVAR_SAMP")
		    | str_p("CORR") | str_p("REGR_SLOPE") | str_p(
								  "REGR_INTERCEPT") | str_p("REGR_COUNT") | str_p("REGR_R2")
		    | str_p("REGR_AVGX") | str_p("REGR_AVGY") | str_p(
								      "REGR_SXX") | str_p("REGR_SYY") | str_p("REGR_SXY");;;
		  ...
		  OrderingSpecification = (str_p("ASC")) | str_p("DESC");;;
		  NullOrdering = (str_p("NULLS")) >> "FIRST" | str_p("NULLS")
						  >> "LAST";;;
		  SchemaDefinition = ((str_p("CREATE")) >> "SCHEMA"
				      >> SchemaNameClause >> !SchemaCharacterSetOrPath
				      >> *SchemaElement);;;
		  SchemaCharacterSetOrPath = SchemaCharacterSetSpecification
		    | SchemaPathSpecification | SchemaCharacterSetSpecification
		    >> SchemaPathSpecification | SchemaPathSpecification
		    >> SchemaCharacterSetSpecification;;;
		  SchemaNameClause = SchemaName | str_p("AUTHORIZATION")
		    >> SchemaAuthorizationIdentifier | SchemaName
		    >> "AUTHORIZATION" >> SchemaAuthorizationIdentifier;;;
		  SchemaAuthorizationIdentifier = AuthorizationIdentifier;;;
		  SchemaCharacterSetSpecification = (str_p("DEFAULT")) >> "CHARACTER"
								       >> "SET" >> CharacterSetSpecification;;;
		  SchemaPathSpecification = PathSpecification;;;
		  SchemaElement = TableDefinition | ViewDefinition | DomainDefinition
		    | CharacterSetDefinition | CollationDefinition
		    | TransliterationDefinition | AssertionDefinition
		    | TriggerDefinition | UserDefinedTypeDefinition
		    | UserDefinedCastDefinition | UserDefinedOrderingDefinition
		    | TransformDefinition | SchemaRoutine
		    | SequenceGeneratorDefinition | GrantStatement
		    | RoleDefinition;;;
		  DropSchemaStatement = (str_p("DROP")) >> "SCHEMA" >> SchemaName
							>> DropBehavior;;;
		  DropBehavior = (str_p("CASCADE")) | "RESTRICT";;;
		  TableDefinition = ((str_p("CREATE")) >> !TableScope >> "TABLE"
				     >> TableName >> TableContentsSource >> !(str_p("ON"))
				     >> "COMMIT" >> TableCommitAction >> "ROWS");;;
		  TableContentsSource = TableElementList | ((str_p("OF"))
							    >> PathResolvedUserDefinedTypeName >> !SubtableClause
							    >> !TableElementList) | AsSubqueryClause;;;
		  TableScope = GlobalOrLocal >> "TEMPORARY";;;
		  GlobalOrLocal = (str_p("GLOBAL")) | str_p("LOCAL");;;
		  TableCommitAction = (str_p("PRESERVE")) | str_p("DELETE");;;
		  TableElementList = (ch_p('(') >> (TableElement % ch_p(',')) >> ')');;;
		  TableElement = ColumnDefinition | TableConstraintDefinition
		    | LikeClause | SelfReferencingColumnSpecification
		    | ColumnOptions;;;
		  SelfReferencingColumnSpecification = (str_p("REF")) >> "IS"
								      >> SelfReferencingColumnName >> ReferenceGeneration;;;
		  ReferenceGeneration = (str_p("SYSTEM")) >> "GENERATED" | str_p(
										 "USER") >> "GENERATED" | str_p("DERIVED");;;
		  SelfReferencingColumnName = ColumnName;;;
		  ColumnOptions = ColumnName >> "WITH" >> "OPTIONS"
					     >> ColumnOptionList;;;
		  ColumnOptionList = !(ScopeClause >> !DefaultClause
		  ...
		  IdentityOption = (str_p("INCLUDING")) >> "IDENTITY" | str_p(
									      "EXCLUDING") >> "IDENTITY";;;
		  ColumnDefaultOption = (str_p("INCLUDING")) >> "DEFAULTS" | str_p(
										   "EXCLUDING") >> "DEFAULTS";;;
		  AsSubqueryClause = !(ch_p('(') >> ColumnNameList >> ')' >> "AS"
				       >> Subquery >> WithOrWithoutData);;;
		  WithOrWithoutData = (str_p("WITH")) >> "NO" >> "DATA" | str_p(
										"WITH") >> "DATA";;;
		  ColumnDefinition = (ColumnName >> !DataType | DomainName
				      >> !ReferenceScopeCheck >> !DefaultClause
				      | IdentityColumnSpecification | GenerationClause
				      >> *ColumnConstraintDefinition >> !CollateClause);;;
		  ColumnConstraintDefinition = !(ConstraintNameDefinition
						 >> ColumnConstraint >> !ConstraintCharacteristics);;;
		  ColumnConstraint = (str_p("NOT")) >> "NULL" | UniqueSpecification
		    | ReferencesSpecification | CheckConstraintDefinition;;;
		  ReferenceScopeCheck = ((str_p("REFERENCES")) >> "ARE" >> !(str_p(
										   "NOT")) >> "CHECKED" >> !(str_p("ON")) >> "DELETE"
					 >> ReferenceScopeCheckAction);;;
		  ReferenceScopeCheckAction = ReferentialAction;;;
		  IdentityColumnSpecification = (str_p("GENERATED") >> "ALWAYS"
						 | str_p("BY") >> "DEFAULT" >> "AS" >> "IDENTITY" >> !ch_p(
		  ...
		  DefaultOption = Literal | DatetimeValueFunction | str_p("USER")
		    | str_p("CURRENT_USER") | str_p("CURRENT_ROLE") | str_p(
									    "SESSION_USER") | str_p("SYSTEM_USER") | str_p(
															   "CURRENT_PATH") | ImplicitlyTypedValueSpecification;;;
		  TableConstraintDefinition = !(ConstraintNameDefinition
		  ...
		  UniqueConstraintDefinition = UniqueSpecification >> '('
								   >> UniqueColumnList >> ')' | ((str_p("UNIQUE")) >> "VALUE");;;
		  UniqueSpecification = (str_p("UNIQUE")) | str_p("PRIMARY") >> "KEY";;;
		  UniqueColumnList = ColumnNameList;;;
		  ReferentialConstraintDefinition = (str_p("FOREIGN")) >> "KEY"
								       >> '(' >> ReferencingColumns >> ')'
								       >> ReferencesSpecification;;;
		  ReferencesSpecification = ((str_p("REFERENCES"))
					     >> ReferencedTableAndColumns >> !(str_p("MATCH"))
					     >> MatchType >> !ReferentialTriggeredAction);;;
		  MatchType = (str_p("FULL")) | str_p("PARTIAL") | str_p("SIMPLE");;;
		  ReferencingColumns = ReferenceColumnList;;;
		  ReferencedTableAndColumns = (TableName >> !ch_p('(')
					       >> ReferenceColumnList >> ')');;;
		  ...
		  ReferentialAction = (str_p("CASCADE")) | str_p("SET") >> "NULL"
		    | str_p("SET") >> "DEFAULT" | str_p("RESTRICT")

		    | str_p("NO") >> "ACTION";;;
		  CheckConstraintDefinition = (str_p("CHECK")) >> '('
							       >> SearchCondition >> ')';;;
		  AlterTableStatement = (str_p("ALTER")) >> "TABLE" >> TableName
							 >> AlterTableAction;;;
		  AlterTableAction = AddColumnDefinition | AlterColumnDefinition
		    | DropColumnDefinition | AddTableConstraintDefinition
		    | DropTableConstraintDefinition;;;
		  AddColumnDefinition = ((str_p("ADD")) >> !(str_p("COLUMN"))
					 >> ColumnDefinition);;;
		  AlterColumnDefinition = ((str_p("ALTER")) >> !(str_p("COLUMN"))
					   >> ColumnName >> AlterColumnAction);;;
		  AlterColumnAction = SetColumnDefaultClause
		    | DropColumnDefaultClause | AddColumnScopeClause
		    | DropColumnScopeClause | AlterIdentityColumnSpecification;;;
		  ...
		  DropColumnDefinition = ((str_p("DROP")) >> !(str_p("COLUMN"))
					  >> ColumnName >> DropBehavior);;;
		  AddTableConstraintDefinition = (str_p("ADD"))
		    >> TableConstraintDefinition;;;
		  DropTableConstraintDefinition = (str_p("DROP")) >> "CONSTRAINT"
								  >> ConstraintName >> DropBehavior;;;
		  DropTableStatement = (str_p("DROP")) >> "TABLE" >> TableName
						       >> DropBehavior;;;
		  ViewDefinition = ((str_p("CREATE")) >> !(str_p("RECURSIVE"))
				    >> "VIEW" >> TableName >> ViewSpecification >> "AS"
				    >> QueryExpression >> !((str_p("WITH")) >> !LevelsClause
							    >> "CHECK" >> "OPTION"));;;
		  ViewSpecification = RegularViewSpecification
		    | ReferenceableViewSpecification;;;
		  RegularViewSpecification = !(ch_p('(') >> ViewColumnList >> ')');;;
		  ReferenceableViewSpecification = ((str_p("OF"))
						    >> PathResolvedUserDefinedTypeName >> !SubviewClause
						    >> !ViewElementList);;;
		  ...
		  LevelsClause = (str_p("CASCADED")) | str_p("LOCAL");;;
		  ViewColumnList = ColumnNameList;;;
		  DropViewStatement = (str_p("DROP")) >> "VIEW" >> TableName
						      >> DropBehavior;;;
		  DomainDefinition = ((str_p("CREATE")) >> "DOMAIN" >> DomainName
				      >> !(str_p("AS")) >> DataType >> !DefaultClause
				      >> *DomainConstraint >> !CollateClause);;;
		  DomainConstraint = !(ConstraintNameDefinition
				       >> CheckConstraintDefinition >> !ConstraintCharacteristics);;;
		  AlterDomainStatement = (str_p("ALTER")) >> "DOMAIN" >> DomainName
							  >> AlterDomainAction;;;
		  AlterDomainAction = SetDomainDefaultClause
		    | DropDomainDefaultClause | AddDomainConstraintDefinition
		  ...
		  DropDomainConstraintDefinition = (str_p("DROP")) >> "CONSTRAINT"
								   >> ConstraintName;;;
		  DropDomainStatement = (str_p("DROP")) >> "DOMAIN" >> DomainName
							>> DropBehavior;;;
		  CharacterSetDefinition = ((str_p("CREATE")) >> "CHARACTER" >> "SET"
					    >> CharacterSetName >> !(str_p("AS")) >> CharacterSetSource
					    >> !CollateClause);;;
		  CharacterSetSource = (str_p("GET")) >> CharacterSetSpecification;;;
		  DropCharacterSetStatement = (str_p("DROP")) >> "CHARACTER" >> "SET"
							      >> CharacterSetName;;;
		  CollationDefinition = ((str_p("CREATE")) >> "COLLATION"
					 >> CollationName >> "FOR" >> CharacterSetSpecification
					 >> "FROM" >> ExistingCollationName >> !PadCharacteristic);;;
		  ExistingCollationName = CollationName;;;
		  PadCharacteristic = (str_p("NO")) >> "PAD" | str_p("PAD")
						    >> "SPACE";;;
		  DropCollationStatement = (str_p("DROP")) >> "COLLATION"
							   >> CollationName >> DropBehavior;;;
		  TransliterationDefinition = (str_p("CREATE")) >> "TRANSLATION"
								>> TransliterationName >> "FOR"
								>> SourceCharacterSetSpecification >> "TO"
								>> TargetCharacterSetSpecification >> "FROM"
		  ...
		  DropTransliterationStatement = (str_p("DROP")) >> "TRANSLATION"
								 >> TransliterationName;;;
		  AssertionDefinition = ((str_p("CREATE")) >> "ASSERTION"
					 >> ConstraintName >> "CHECK" >> '(' >> SearchCondition
					 >> ')' >> !ConstraintCharacteristics);;;
		  DropAssertionStatement = (str_p("DROP")) >> "ASSERTION"
							   >> ConstraintName;;;
		  TriggerDefinition = ((str_p("CREATE")) >> "TRIGGER" >> TriggerName
				       >> TriggerActionTime >> TriggerEvent >> "ON" >> TableName
				       >> !(str_p("REFERENCING")) >> OldOrNewValuesAliasList
				       >> TriggeredAction);;;
		  TriggerActionTime = (str_p("BEFORE")) | str_p("AFTER");;;
		  TriggerEvent = (str_p("INSERT")) | str_p("DELETE") | ((str_p(
									       "UPDATE")) >> !(str_p("OF")) >> TriggerColumnList);;;
		  TriggerColumnList = ColumnNameList;;;
		  TriggeredAction = !(((str_p("FOR")) >> "EACH" >> "ROW" | str_p(
										 "STATEMENT")) >> !(str_p("WHEN")) >> '(' >> SearchCondition
				      >> ')' >> TriggeredSQLStatement);;;
		  TriggeredSQLStatement = SQLProcedureStatement | ((str_p("BEGIN"))
								   >> "ATOMIC" >> +SQLProcedureStatement >> ';' >> "END");;;
		  OldOrNewValuesAliasList = +OldOrNewValuesAlias;;;
		  OldOrNewValuesAlias = ((str_p("OLD")) >> !(str_p("ROW"))
					 >> !(str_p("AS")) >> OldValuesCorrelationName) | ((str_p(
												  "NEW")) >> !(str_p("ROW")) >> !(str_p("AS"))
											   >> NewValuesCorrelationName) | ((str_p("OLD")) >> "TABLE"
															   >> !(str_p("AS")) >> OldValuesTableAlias) | ((str_p("NEW"))
																					>> "TABLE" >> !(str_p("AS")) >> NewValuesTableAlias);;;
		  ...
		  UserDefinedTypeDefinition = (str_p("CREATE")) >> "TYPE"
								>> UserDefinedTypeBody;;;
		  UserDefinedTypeBody = (SchemaResolvedUserDefinedTypeName
					 >> !SubtypeClause >> !(str_p("AS")) >> Representation
					 >> !UserDefinedTypeOptionList >> !MethodSpecificationList);;;
		  UserDefinedTypeOptionList = (UserDefinedTypeOption
					       >> *UserDefinedTypeOption);;;
		  UserDefinedTypeOption = InstantiableClause | Finality
		    | ReferenceTypeSpecification | RefCastOption | CastOption;;;
		  ...
		  InstantiableClause = (str_p("INSTANTIABLE")) | str_p("NOT")
		    >> "INSTANTIABLE";;;
		  Finality = (str_p("FINAL")) | str_p("NOT") >> "FINAL";;;
		  ReferenceTypeSpecification = UserDefinedRepresentation
		    | DerivedRepresentation | SystemGeneratedRepresentation;;;
		  UserDefinedRepresentation = (str_p("REF")) >> "USING"
							     >> PredefinedType;;;
		  DerivedRepresentation = (str_p("REF")) >> "FROM"
							 >> ListOfAttributes;;;
		  SystemGeneratedRepresentation = (str_p("REF")) >> "IS" >> "SYSTEM"
								 >> "GENERATED";;;
		  RefCastOption = !(CastToRef >> !CastToType);;;
		  CastToRef = (str_p("CAST")) >> '(' >> "SOURCE" >> "AS" >> "REF"
					      >> ')' >> "WITH" >> CastToRefIdentifier;;;
		  CastToRefIdentifier = Identifier;;;
		  CastToType = (str_p("CAST")) >> '(' >> "REF" >> "AS" >> "SOURCE"
					       >> ')' >> "WITH" >> CastToTypeIdentifier;;;
		  CastToTypeIdentifier = Identifier;;;
		  ListOfAttributes
		    = (ch_p('(') >> (AttributeName % ch_p(',')) >> ')');;;
		  CastOption = !(CastToDistinct >> !CastToSource);;;
		  CastToDistinct = (str_p("CAST")) >> '(' >> "SOURCE" >> "AS"
						   >> "DISTINCT" >> ')' >> "WITH" >> CastToDistinctIdentifier;;;
		  CastToDistinctIdentifier = Identifier;;;
		  CastToSource = (str_p("CAST")) >> '(' >> "DISTINCT" >> "AS"
						 >> "SOURCE" >> ')' >> "WITH" >> CastToSourceIdentifier;;;
		  ...
		  OriginalMethodSpecification = (PartialMethodSpecification
						 >> !(str_p("SELF")) >> "AS" >> "RESULT" >> !(str_p("SELF"))
						 >> "AS" >> "LOCATOR" >> !MethodCharacteristics);;;
		  OverridingMethodSpecification = (str_p("OVERRIDING"))
		  ...
		  MethodCharacteristic = LanguageClause | ParameterStyleClause
		    | DeterministicCharacteristic | SQLDataAccessIndication
		    | NullCallClause;;;
		  AttributeDefinition = (AttributeName >> DataType
					 >> !ReferenceScopeCheck >> !AttributeDefault
					 >> !CollateClause);;;
		  AttributeDefault = DefaultClause;;;
		  AlterTypeStatement = (str_p("ALTER")) >> "TYPE"
							>> SchemaResolvedUserDefinedTypeName >> AlterTypeAction;;;
		  AlterTypeAction = AddAttributeDefinition | DropAttributeDefinition
		    | AddOriginalMethodSpecification
		    | AddOverridingMethodSpecification
		    | DropMethodSpecification;;;
		  AddAttributeDefinition = (str_p("ADD")) >> "ATTRIBUTE"
							  >> AttributeDefinition;;;
		  DropAttributeDefinition = (str_p("DROP")) >> "ATTRIBUTE"
							    >> AttributeName >> "RESTRICT";;;
		  AddOriginalMethodSpecification = (str_p("ADD"))
		    >> OriginalMethodSpecification;;;
		  AddOverridingMethodSpecification = (str_p("ADD"))
		    >> OverridingMethodSpecification;;;
		  DropMethodSpecification = (str_p("DROP"))
		    >> SpecificMethodSpecificationDesignator >> "RESTRICT";;;
		  SpecificMethodSpecificationDesignator = !((str_p("INSTANCE"))
							    | str_p("STATIC") | str_p("CONSTRUCTOR")) >> "METHOD"
												      >> MethodName >> DataTypeList;;;
		  DropDataTypeStatement = (str_p("DROP")) >> "TYPE"
							  >> SchemaResolvedUserDefinedTypeName >> DropBehavior;;;
		  ...
		  SQLInvokedProcedure = (str_p("PROCEDURE"))
		    >> SchemaQualifiedRoutineName
		    >> SQLParameterDeclarationList >> RoutineCharacteristics
		    >> RoutineBody;;;
		  SQLInvokedFunction = (FunctionSpecification
					| MethodSpecificationDesignator >> RoutineBody);;;
		  SQLParameterDeclarationList = (ch_p('(')
						 >> !((SQLParameterDeclaration % ch_p(','))) >> ')');;;
		  SQLParameterDeclaration = !(ParameterMode >> !SQLParameterName
					      >> ParameterType >> !(str_p("RESULT")));;;
		  ParameterMode = (str_p("IN")) | str_p("OUT") | str_p("INOUT");;;
		  ParameterType = (DataType >> !LocatorIndication);;;
		  LocatorIndication = (str_p("AS")) >> "LOCATOR";;;
		  FunctionSpecification = ((str_p("FUNCTION"))
					   >> SchemaQualifiedRoutineName
					   >> SQLParameterDeclarationList >> ReturnsClause
					   >> RoutineCharacteristics >> !DispatchClause);;;
		  MethodSpecificationDesignator = (str_p("SPECIFIC")) >> "METHOD"
								      >> SpecificMethodName | !((str_p("INSTANCE")) | str_p(
															    "STATIC") | str_p("CONSTRUCTOR") >> "METHOD" >> MethodName
												>> SQLParameterDeclarationList >> !ReturnsClause >> "FOR"
												>> SchemaResolvedUserDefinedTypeName);;;
		  RoutineCharacteristics = *(RoutineCharacteristic);;;
		  RoutineCharacteristic = LanguageClause | ParameterStyleClause
		    | str_p("SPECIFIC") >> SpecificName
		    | DeterministicCharacteristic | SQLDataAccessIndication
		    | NullCallClause | DynamicResultSetsCharacteristic
		    | SavepointLevelIndication;;;
		  SavepointLevelIndication = (str_p("NEW")) >> "SAVEPOINT" >> "LEVEL"
		    | str_p("OLD") >> "SAVEPOINT" >> "LEVEL";;;
		  DynamicResultSetsCharacteristic = (str_p("DYNAMIC")) >> "RESULT"
								       >> "SETS" >> MaximumDynamicResultSets;;;
		  ParameterStyleClause = (str_p("PARAMETER")) >> "STYLE"
							      >> ParameterStyle;;;
		  ...
		  TableFunctionColumnList = (ch_p('(')
					     >> (TableFunctionColumnListElement % ch_p(',')) >> ')');;;
		  ...
		  RightsClause = (str_p("SQL")) >> "SECURITY" >> "INVOKER" | str_p(
										   "SQL") >> "SECURITY" >> "DEFINER";;;
		  SQLRoutineBody = SQLProcedureStatement;;;
		  ExternalBodyReference = ((str_p("EXTERNAL")) >> !(str_p("NAME"))
					   >> ExternalRoutineName >> !ParameterStyleClause
					   >> !TransformGroupSpecification >> !ExternalSecurityClause);;;
		  ExternalSecurityClause = (str_p("EXTERNAL")) >> "SECURITY"
							       >> "DEFINER" | str_p("EXTERNAL") >> "SECURITY" >> "INVOKER"
		    | str_p("EXTERNAL") >> "SECURITY" >> "IMPLEMENTATION"
							       >> "DEFINED";;;
		  ParameterStyle = (str_p("SQL")) | str_p("GENERAL");;;
		  DeterministicCharacteristic = (str_p("DETERMINISTIC")) | str_p(
										 "NOT") >> "DETERMINISTIC";;;
		  SQLDataAccessIndication = (str_p("NO")) >> "SQL"
		    | str_p("CONTAINS") >> "SQL" | str_p("READS") >> "SQL"
							  >> "DATA" | str_p("MODIFIES") >> "SQL" >> "DATA";;;
		  NullCallClause = (str_p("RETURNS")) >> "NULL" >> "ON" >> "NULL"
						      >> "INPUT" | str_p("CALLED") >> "ON" >> "NULL" >> "INPUT";;;
		  MaximumDynamicResultSets = uint_p;;;
		  TransformGroupSpecification = ((str_p("TRANSFORM")) >> "GROUP"
						 >> SingleGroupSpecification | MultipleGroupSpecification);;;
		  SingleGroupSpecification = GroupName;;;
		  MultipleGroupSpecification = ((GroupSpecification % ch_p(',')));;;
		  GroupSpecification = GroupName >> "FOR" >> "TYPE"
						 >> PathResolvedUserDefinedTypeName;;;
		  AlterRoutineStatement = (str_p("ALTER"))
		    >> SpecificRoutineDesignator >> AlterRoutineCharacteristics
		    >> AlterRoutineBehavior;;;
		  AlterRoutineCharacteristics = +AlterRoutineCharacteristic;;;
		  AlterRoutineCharacteristic = LanguageClause | ParameterStyleClause
		    | SQLDataAccessIndication | NullCallClause
		    | DynamicResultSetsCharacteristic | str_p("NAME")
		    >> ExternalRoutineName;;;
		  AlterRoutineBehavior =str_p("RESTRICT");;;
		  DropRoutineStatement = (str_p("DROP")) >> SpecificRoutineDesignator
							 >> DropBehavior;;;
		  UserDefinedCastDefinition
		    = ((str_p("CREATE")) >> "CAST" >> '(' >> SourceDataType
		       >> "AS" >> TargetDataType >> ')' >> "WITH"
		       >> CastFunction >> !(str_p("AS")) >> "ASSIGNMENT");;;
		  CastFunction = SpecificRoutineDesignator;;;
		  SourceDataType = DataType;;;
		  TargetDataType = DataType;;;
		  DropUserDefinedCastStatement = (str_p("DROP")) >> "CAST" >> '('
								 >> SourceDataType >> "AS" >> TargetDataType >> ')'
								 >> DropBehavior;;;
		  UserDefinedOrderingDefinition = (str_p("CREATE")) >> "ORDERING"
								    >> "FOR" >> SchemaResolvedUserDefinedTypeName
								    >> OrderingForm;;;
		  OrderingForm = EqualsOrderingForm | FullOrderingForm;;;
		  EqualsOrderingForm = (str_p("EQUALS")) >> "ONLY" >> "BY"
							 >> OrderingCategory;;;
		  FullOrderingForm = (str_p("ORDER")) >> "FULL" >> "BY"
						      >> OrderingCategory;;;
		  OrderingCategory = RelativeCategory | MapCategory | StateCategory;;;
		  RelativeCategory = (str_p("RELATIVE")) >> "WITH"
		  ...
		  DropUserDefinedOrderingStatement = (str_p("DROP")) >> "ORDERING"
								     >> "FOR" >> SchemaResolvedUserDefinedTypeName
								     >> DropBehavior;;;
		  TransformDefinition = ((str_p("CREATE")) >> "TRANSFORM" | str_p(
										  "TRANSFORMS") >> "FOR" >> SchemaResolvedUserDefinedTypeName
					 >> +TransformGroup);;;
		  TransformGroup = GroupName >> '(' >> TransformElementList >> ')';;;
		  GroupName = Identifier;;;
		  TransformElementList = (TransformElement >> !ch_p(',')
					  >> TransformElement);;;
		  ...
		  AlterTransformStatement = ((str_p("ALTER")) >> "TRANSFORM" | str_p(
										     "TRANSFORMS") >> "FOR" >> SchemaResolvedUserDefinedTypeName
					     >> +AlterGroup);;;
		  ...
		  AddTransformElementList = (str_p("ADD")) >> '('
							   >> TransformElementList >> ')';;;
		  DropTransformElementList = ((str_p("DROP")) >> '(' >> TransformKind
					      >> !ch_p(',') >> TransformKind >> DropBehavior >> ')');;;
		  TransformKind = (str_p("TO")) >> "SQL" | str_p("FROM") >> "SQL";;;
		  DropTransformStatement = ((str_p("DROP")) >> "TRANSFORM" | str_p(
										   "TRANSFORMS") >> TransformsToBeDropped >> "FOR"
					    >> SchemaResolvedUserDefinedTypeName >> DropBehavior);;;
		  TransformsToBeDropped = (str_p("ALL")) | TransformGroupElement;;;
		  TransformGroupElement = GroupName;;;
		  SequenceGeneratorDefinition = ((str_p("CREATE")) >> "SEQUENCE"
						 >> SequenceGeneratorName >> !SequenceGeneratorOptions);;;
		  ...
		  SequenceGeneratorStartWithOption = (str_p("START")) >> "WITH"
								      >> SequenceGeneratorStartValue;;;
		  SequenceGeneratorStartValue = SignedNumericLiteral;;;
		  SequenceGeneratorIncrementByOption = (str_p("INCREMENT")) >> "BY"
									    >> SequenceGeneratorIncrement;;;
		  SequenceGeneratorIncrement = SignedNumericLiteral;;;
		  SequenceGeneratorMaxvalueOption = (str_p("MAXVALUE"))
		    >> SequenceGeneratorMaxValue | str_p("NO") >> "MAXVALUE";;;
		  SequenceGeneratorMaxValue = SignedNumericLiteral;;;
		  SequenceGeneratorMinvalueOption = (str_p("MINVALUE"))
		    >> SequenceGeneratorMinValue | str_p("NO") >> "MINVALUE";;;
		  SequenceGeneratorMinValue = SignedNumericLiteral;;;
		  SequenceGeneratorCycleOption = (str_p("CYCLE")) | str_p("NO")
		    >> "CYCLE";;;
		  AlterSequenceGeneratorStatement = (str_p("ALTER")) >> "SEQUENCE"
								     >> SequenceGeneratorName >> AlterSequenceGeneratorOptions;;;
		  ...
		  AlterSequenceGeneratorOption = AlterSequenceGeneratorRestartOption
		    | BasicSequenceGeneratorOption;;;
		  AlterSequenceGeneratorRestartOption = (str_p("RESTART")) >> "WITH"
									   >> SequenceGeneratorRestartValue;;;
		  SequenceGeneratorRestartValue = SignedNumericLiteral;;;
		  DropSequenceGeneratorStatement = (str_p("DROP")) >> "SEQUENCE"
								   >> SequenceGeneratorName >> DropBehavior;;;
		  GrantStatement = GrantPrivilegeStatement | GrantRoleStatement;;;
		  GrantPrivilegeStatement = ((str_p("GRANT")) >> Privileges >> "TO"
					     >> (Grantee % ch_p(',')) >> !(str_p("WITH")) >> "HIERARCHY"
					     >> "OPTION" >> !(str_p("WITH")) >> "GRANT" >> "OPTION"
					     >> !(str_p("GRANTED")) >> "BY" >> Grantor);;;
		  Privileges = ObjectPrivileges >> "ON" >> ObjectName;;;
		  ObjectName = !((str_p("TABLE")) >> TableName) | str_p("DOMAIN")
		    >> DomainName | str_p("COLLATION") >> CollationName
		    | str_p("CHARACTER") >> "SET" >> CharacterSetName | str_p(
									      "TRANSLATION") >> TransliterationName | str_p("TYPE")
		    >> SchemaResolvedUserDefinedTypeName | str_p("SEQUENCE")
		    >> SequenceGeneratorName | SpecificRoutineDesignator;;;
		  ObjectPrivileges = (str_p("ALL")) >> "PRIVILEGES" | ((Action
									% ch_p(',')));;;
		  Action = (str_p("SELECT")) | str_p("SELECT") >> '('
							       >> PrivilegeColumnList >> ')' | str_p("SELECT") >> '('
							       >> PrivilegeMethodList >> ')' | str_p("DELETE") | ((str_p(
															 "INSERT")) >> !ch_p('(') >> PrivilegeColumnList >> ')')
		    | ((str_p("UPDATE")) >> !ch_p('(') >> PrivilegeColumnList
		       >> ')') | ((str_p("REFERENCES")) >> !ch_p('(')
				  >> PrivilegeColumnList >> ')') | str_p("USAGE") | str_p(
											  "TRIGGER") | str_p("UNDER") | str_p("EXECUTE");;;
		  ...
		  Grantor = (str_p("CURRENT_USER")) | str_p("CURRENT_ROLE");;;
		  RoleDefinition = ((str_p("CREATE")) >> "ROLE" >> RoleName
				    >> !(str_p("WITH")) >> "ADMIN" >> Grantor);;;
		  GrantRoleStatement = ((str_p("GRANT")) >> (RoleGranted % ch_p(','))
					>> "TO" >> (Grantee % ch_p(',')) >> !(str_p("WITH"))
					>> "ADMIN" >> "OPTION" >> !(str_p("GRANTED")) >> "BY"
					>> Grantor);;;
		  ...
		  RevokePrivilegeStatement = ((str_p("REVOKE"))
					      >> !RevokeOptionExtension >> Privileges >> "FROM"
					      >> (Grantee % ch_p(',')) >> !(str_p("GRANTED")) >> "BY"
					      >> Grantor >> DropBehavior);;;
		  RevokeOptionExtension = (str_p("GRANT")) >> "OPTION" >> "FOR"
		    | str_p("HIERARCHY") >> "OPTION" >> "FOR";;;
		  RevokeRoleStatement = ((str_p("REVOKE")) >> !(str_p("ADMIN"))
					 >> "OPTION" >> "FOR" >> (RoleRevoked % ch_p(',')) >> "FROM"
					 >> (Grantee % ch_p(',')) >> !(str_p("GRANTED")) >> "BY"
					 >> Grantor >> DropBehavior);;;
		  RoleRevoked = RoleName;;;
		  SQLClientModuleDefinition = (ModuleNameClause >> LanguageClause
					       >> ModuleAuthorizationClause >> !ModulePathSpecification
					       >> !ModuleTransformGroupSpecification >> !ModuleCollations
					       >> *TemporaryTableDeclaration >> +ModuleContents);;;
		  ModuleAuthorizationClause = (str_p("SCHEMA")) >> SchemaName
		    | ((str_p("AUTHORIZATION"))
		       >> ModuleAuthorizationIdentifier
		       >> !((str_p("FOR")) >> "STATIC" >> "ONLY" | str_p(
									 "AND") >> "DYNAMIC")) | ((str_p("SCHEMA"))
												  >> SchemaName >> "AUTHORIZATION"
												  >> ModuleAuthorizationIdentifier >> !((str_p("FOR"))
																	>> "STATIC" >> "ONLY" | str_p("AND") >> "DYNAMIC"));;;
		  ...
		  ModuleCollationSpecification = ((str_p("COLLATION"))
						  >> CollationName >> !(str_p("FOR"))
						  >> CharacterSetSpecificationList);;;
		  CharacterSetSpecificationList = ((CharacterSetSpecification % ch_p(
										     ',')));;;
		  ModuleContents = DeclareCursor | DynamicDeclareCursor
		    | ExternallyInvokedProcedure;;;
		  ModuleNameClause = ((str_p("MODULE")) >> !SQLClientModuleName
				      >> !ModuleCharacterSetSpecification);;;
		  ModuleCharacterSetSpecification = (str_p("NAMES")) >> "ARE"
								     >> CharacterSetSpecification;;;
		  ExternallyInvokedProcedure = (str_p("PROCEDURE")) >> ProcedureName
								    >> HostParameterDeclarationList >> ';'
								    >> SQLProcedureStatement >> ';';;;
		  HostParameterDeclarationList = (ch_p('(')
						  >> (HostParameterDeclaration % ch_p(',')) >> ')');;;
		  HostParameterDeclaration = HostParameterName
		    >> HostParameterDataType | StatusParameter;;;
		  ...
		  SQLExecutableStatement = SQLSchemaStatement | SQLDataStatement
		    | SQLControlStatement | SQLTransactionStatement
		    | SQLConnectionStatement | SQLSessionStatement
		    | SQLDiagnosticsStatement | SQLDynamicStatement;;;
		  SQLSchemaStatement = SQLSchemaDefinitionStatement
		    | SQLSchemaManipulationStatement;;;
		  SQLSchemaDefinitionStatement = SchemaDefinition | TableDefinition
		    | ViewDefinition | SQLInvokedRoutine | GrantStatement
		    | RoleDefinition | DomainDefinition
		    | CharacterSetDefinition | CollationDefinition
		    | TransliterationDefinition | AssertionDefinition
		    | TriggerDefinition | UserDefinedTypeDefinition
		    | UserDefinedCastDefinition | UserDefinedOrderingDefinition
		    | TransformDefinition | SequenceGeneratorDefinition;;;
		  SQLSchemaManipulationStatement = DropSchemaStatement
		    | AlterTableStatement | DropTableStatement
		    | DropViewStatement | AlterRoutineStatement
		    | DropRoutineStatement | DropUserDefinedCastStatement
		    | RevokeStatement | DropRoleStatement
		    | AlterDomainStatement | DropDomainStatement
		    | DropCharacterSetStatement | DropCollationStatement
		    | DropTransliterationStatement | DropAssertionStatement
		    | DropTriggerStatement | AlterTypeStatement
		    | DropDataTypeStatement | DropUserDefinedOrderingStatement
		    | AlterTransformStatement | DropTransformStatement
		    | AlterSequenceGeneratorStatement
		    | DropSequenceGeneratorStatement;;;
		  SQLDataStatement = OpenStatement | FetchStatement | CloseStatement
		    | SelectStatementSingleRow | FreeLocatorStatement
		    | HoldLocatorStatement | SQLDataChangeStatement;;;
		  SQLDataChangeStatement = DeleteStatementPositioned
		    | DeleteStatementSearched | InsertStatement
		    | UpdateStatementPositioned | UpdateStatementSearched
		    | MergeStatement;;;
		  SQLControlStatement = CallStatement | ReturnStatement;;;
		  SQLTransactionStatement = StartTransactionStatement
		    | SetTransactionStatement | SetConstraintsModeStatement
		    | SavepointStatement | ReleaseSavepointStatement
		    | CommitStatement | RollbackStatement;;;
		  SQLConnectionStatement = ConnectStatement | SetConnectionStatement
		    | DisconnectStatement;;;
		  SQLSessionStatement = SetSessionUserIdentifierStatement
		    | SetRoleStatement | SetLocalTimeZoneStatement
		    | SetSessionCharacteristicsStatement | SetCatalogStatement
		    | SetSchemaStatement | SetNamesStatement | SetPathStatement
		    | SetTransformGroupStatement | SetSessionCollationStatement;;;
		  SQLDiagnosticsStatement = GetDiagnosticsStatement;;;
		  SQLDynamicStatement = SystemDescriptorStatement | PrepareStatement
		    | DeallocatePreparedStatement | DescribeStatement
		    | ExecuteStatement | ExecuteImmediateStatement
		    | SQLDynamicDataStatement;;;
		  SQLDynamicDataStatement = AllocateCursorStatement
		    | DynamicOpenStatement | DynamicFetchStatement
		    | DynamicCloseStatement | DynamicDeleteStatementPositioned
		    | DynamicUpdateStatementPositioned;;;
		  SystemDescriptorStatement = AllocateDescriptorStatement
		    | DeallocateDescriptorStatement | SetDescriptorStatement
		    | GetDescriptorStatement;;;//>> Table >> 16--Data >> type >> correspondences >> for >> C;;;
		  DeclareCursor = ((str_p("DECLARE")) >> CursorName
				   >> !CursorSensitivity >> !CursorScrollability >> "CURSOR"
				   >> !CursorHoldability >> !CursorReturnability >> "FOR"
				   >> CursorSpecification);;;
		  CursorSensitivity = (str_p("SENSITIVE")) | str_p("INSENSITIVE")
		    | str_p("ASENSITIVE");;;
		  CursorScrollability = (str_p("SCROLL")) | str_p("NO") >> "SCROLL";;;
		  CursorHoldability = (str_p("WITH")) >> "HOLD" | str_p("WITHOUT")
						      >> "HOLD";;;
		  CursorReturnability = (str_p("WITH")) >> "RETURN"
		    | str_p("WITHOUT") >> "RETURN";;;
		  CursorSpecification = (QueryExpression >> !OrderByClause
					 >> !UpdatabilityClause);;;
		  UpdatabilityClause = ((str_p("FOR")) >> "READ" >> "ONLY" | ((str_p(
										     "UPDATE")) >> !(str_p("OF")) >> ColumnNameList));;;
		  OrderByClause = (str_p("ORDER")) >> "BY" >> SortSpecificationList;;;
		  OpenStatement = (str_p("OPEN")) >> CursorName;;;
		  FetchStatement = ((str_p("FETCH"))
				    >> !!(FetchOrientation >> "FROM") >> CursorName >> "INTO"
				    >> FetchTargetList);;;
		  FetchOrientation = (str_p("NEXT")) | str_p("PRIOR")
		    | str_p("FIRST") | str_p("LAST") | ((str_p("ABSOLUTE"))
							| str_p("RELATIVE") >> SimpleValueSpecification);;;
		  FetchTargetList = TargetSpecification % ch_p(',');;;

		  CloseStatement = (str_p("CLOSE")) >> CursorName;;;
		  SelectStatementSingleRow = ((str_p("SELECT")) >> !SetQuantifier
					      >> SelectList >> "INTO" >> SelectTargetList
					      >> TableExpression);;;
		  SelectTargetList = ((TargetSpecification % ch_p(',')));;;
		  DeleteStatementPositioned = (str_p("DELETE")) >> "FROM"
								>> TargetTable >> "WHERE" >> "CURRENT" >> "OF"
								>> CursorName;;;
		  TargetTable = TableName | str_p("ONLY") >> '(' >> TableName >> ')';;;
		  DeleteStatementSearched = ((str_p("DELETE")) >> "FROM"
					     >> TargetTable >> !(str_p("WHERE")) >> SearchCondition);;;
		  InsertStatement = (str_p("INSERT")) >> "INTO" >> InsertionTarget
						      >> InsertColumnsAndSource;;;
		  InsertionTarget = TableName;;;
		  InsertColumnsAndSource = FromSubquery | FromConstructor
		    | FromDefault;;;
		  FromSubquery = !(ch_p('(') >> InsertColumnList >> ')'
				   >> !OverrideClause >> QueryExpression);;;
		  FromConstructor = !(ch_p('(') >> InsertColumnList >> ')'
				      >> !OverrideClause
		  ...
		  MergeStatement = ((str_p("MERGE")) >> "INTO" >> TargetTable
				    >> !!((str_p("AS")) >> MergeCorrelationName) >> "USING"
				    >> TableReference >> "ON" >> SearchCondition
		  ...
		  MergeWhenMatchedClause = (str_p("WHEN")) >> "MATCHED" >> "THEN"
							   >> MergeUpdateSpecification;;;
		  MergeWhenNotMatchedClause = (str_p("WHEN")) >> "NOT" >> "MATCHED"
							      >> "THEN" >> MergeInsertSpecification;;;
		  MergeUpdateSpecification = (str_p("UPDATE")) >> "SET"
							       >> SetClauseList;;;
		  MergeInsertSpecification = ((str_p("INSERT")) >> !ch_p('(')
					      >> InsertColumnList >> ')' >> !OverrideClause >> "VALUES"
					      >> MergeInsertValueList);;;
		  MergeInsertValueList = (ch_p('(') >> (MergeInsertValueElement
							% ch_p(',')) >> ')');;;
		  MergeInsertValueElement = ValueExpression
		    | ContextuallyTypedValueSpecification;;;
		  UpdateStatementPositioned = (str_p("UPDATE")) >> TargetTable
								>> "SET" >> SetClauseList >> "WHERE" >> "CURRENT" >> "OF"
								>> CursorName;;;
		  UpdateStatementSearched = ((str_p("UPDATE")) >> TargetTable
					     >> "SET" >> SetClauseList >> !(str_p("WHERE"))
					     >> SearchCondition);;;
		  SetClauseList = ((SetClause % ch_p(',')));;;
		  SetClause = MultipleColumnAssignment | SetTarget >> '='
								   >> UpdateSource;;;
		  ...
		  UpdateTarget = ObjectColumn | ObjectColumn >> ch_p('[')
							     >> SimpleValueSpecification >> ch_p(']');;;
		  ...
		  UpdateSource = ValueExpression
		    | ContextuallyTypedValueSpecification;;;
		  TemporaryTableDeclaration = ((str_p("DECLARE")) >> "LOCAL"
					       >> "TEMPORARY" >> "TABLE" >> TableName >> TableElementList
					       >> !(str_p("ON")) >> "COMMIT" >> TableCommitAction
					       >> "ROWS");;;
		  FreeLocatorStatement = ((str_p("FREE")) >> "LOCATOR"
					  >> (LocatorReference % ch_p(',')));;;
		  LocatorReference = HostParameterName | EmbeddedVariableName;;;
		  HoldLocatorStatement = ((str_p("HOLD")) >> "LOCATOR"
					  >> (LocatorReference % ch_p(',')));;;
		  CallStatement = (str_p("CALL")) >> RoutineInvocation;;;
		  ReturnStatement = (str_p("RETURN")) >> ReturnValue;;;
		  ReturnValue = ValueExpression | str_p("NULL");;;
		  StartTransactionStatement = ((str_p("START")) >> "TRANSACTION"
					       >> !((TransactionMode % ch_p(','))));;;
		  TransactionMode = IsolationLevel | TransactionAccessMode
		    | DiagnosticsSize;;;
		  TransactionAccessMode = (str_p("READ")) >> "ONLY" | str_p("READ")
							  >> "WRITE";;;
		  IsolationLevel = (str_p("ISOLATION")) >> "LEVEL"
							>> LevelOfIsolation;;;
		  LevelOfIsolation = (str_p("READ")) >> "UNCOMMITTED" | str_p("READ")
						     >> "COMMITTED" | str_p("REPEATABLE") >> "READ" | str_p(
													    "SERIALIZABLE");;;
		  DiagnosticsSize = (str_p("DIAGNOSTICS")) >> "SIZE"
							   >> NumberOfConditions;;;
		  NumberOfConditions = SimpleValueSpecification;;;
		  SetTransactionStatement = ((str_p("SET")) >> !(str_p("LOCAL"))
					     >> TransactionCharacteristics);;;
		  TransactionCharacteristics = ((str_p("TRANSACTION"))
						>> (TransactionMode % ch_p(',')));;;
		  SetConstraintsModeStatement = ((str_p("SET")) >> "CONSTRAINTS"
						 >> ConstraintNameList >> "DEFERRED" | str_p("IMMEDIATE"));;;
		  ConstraintNameList = (str_p("ALL"))
		    | ((ConstraintName % ch_p(',')));;;
		  SavepointStatement = (str_p("SAVEPOINT")) >> SavepointSpecifier;;;
		  SavepointSpecifier = SavepointName;;;
		  ReleaseSavepointStatement = (str_p("RELEASE")) >> "SAVEPOINT"
								 >> SavepointSpecifier;;;
		  CommitStatement = ((str_p("COMMIT")) >> !(str_p("WORK"))
				     >> !((str_p("AND")) >> !(str_p("NO")) >> "CHAIN"));;;
		  RollbackStatement = ((str_p("ROLLBACK")) >> !(str_p("WORK"))
				       >> !((str_p("AND")) >> !(str_p("NO")) >> "CHAIN")
				       >> !SavepointClause);;;
		  SavepointClause = (str_p("TO")) >> "SAVEPOINT"
						  >> SavepointSpecifier;;;
		  ConnectStatement = (str_p("CONNECT")) >> "TO" >> ConnectionTarget;;;
		  ConnectionTarget
		    = (SQLServerName >> !(str_p("AS")) >> ConnectionName
		       >> !(str_p("USER")) >> ConnectionUserName) | str_p(
									  "DEFAULT");;;
		  SetConnectionStatement = (str_p("SET")) >> "CONNECTION"
							  >> ConnectionObject;;;
		  ConnectionObject = (str_p("DEFAULT")) | ConnectionName;;;
		  DisconnectStatement = (str_p("DISCONNECT")) >> DisconnectObject;;;
		  DisconnectObject = ConnectionObject | str_p("ALL") | str_p(
									     "CURRENT");;;
		  SetSessionCharacteristicsStatement = (str_p("SET")) >> "SESSION"
								      >> "CHARACTERISTICS" >> "AS" >> SessionCharacteristicList;;;
		  SessionCharacteristicList = ((SessionCharacteristic % ch_p(',')));;;
		  SessionCharacteristic = TransactionCharacteristics;;;
		  SetSessionUserIdentifierStatement = (str_p("SET")) >> "SESSION"
								     >> "AUTHORIZATION" >> ValueSpecification;;;
		  SetRoleStatement = (str_p("SET")) >> "ROLE" >> RoleSpecification;;;
		  RoleSpecification = ValueSpecification | str_p("NONE");;;
		  SetLocalTimeZoneStatement = (str_p("SET")) >> "TIME" >> "ZONE"
							     >> SetTimeZoneValue;;;
		  SetTimeZoneValue = IntervalValueExpression | str_p("LOCAL");;;
		  SetCatalogStatement = (str_p("SET")) >> CatalogNameCharacteristic;;;
		  CatalogNameCharacteristic = (str_p("CATALOG"))
		    >> ValueSpecification;;;
		  SetSchemaStatement = (str_p("SET")) >> SchemaNameCharacteristic;;;
		  SchemaNameCharacteristic = (str_p("SCHEMA")) >> ValueSpecification;;;
		  SetNamesStatement = (str_p("SET"))
		    >> CharacterSetNameCharacteristic;;;
		  CharacterSetNameCharacteristic = (str_p("NAMES"))
		    >> ValueSpecification;;;
		  SetPathStatement = (str_p("SET")) >> SQLPathCharacteristic;;;
		  SQLPathCharacteristic = (str_p("PATH")) >> ValueSpecification;;;
		  SetTransformGroupStatement = (str_p("SET"))
		    >> TransformGroupCharacteristic;;;
		  TransformGroupCharacteristic = (str_p("DEFAULT")) >> "TRANSFORM"
								    >> "GROUP" >> ValueSpecification | str_p("TRANSFORM")
								    >> "GROUP" >> "FOR" >> "TYPE"
								    >> PathResolvedUserDefinedTypeName >> ValueSpecification;;;
		  SetSessionCollationStatement = ((str_p("SET")) >> "COLLATION"
						  >> CollationSpecification >> !(str_p("FOR"))
						  >> CharacterSetSpecificationList) | ((str_p("SET")) >> "NO"
										       >> "COLLATION" >> !(str_p("FOR"))
										       >> CharacterSetSpecificationList);;;
		  CharacterSetSpecificationList = (CharacterSetSpecification % ch_p(
										    ','));;;
		  CollationSpecification = ValueSpecification;;;
		  AllocateDescriptorStatement = ((str_p("ALLOCATE"))
						 >> !(str_p("SQL")) >> "DESCRIPTOR" >> DescriptorName
						 >> !(str_p("WITH")) >> "MAX" >> Occurrences);;;
		  Occurrences = SimpleValueSpecification;;;
		  DeallocateDescriptorStatement = ((str_p("DEALLOCATE")) >> !(str_p(
										    "SQL")) >> "DESCRIPTOR" >> DescriptorName);;;
		  GetDescriptorStatement = ((str_p("GET")) >> !(str_p("SQL"))
					    >> "DESCRIPTOR" >> DescriptorName
					    >> GetDescriptorInformation);;;
		  GetDescriptorInformation = ((GetHeaderInformation % ch_p(',')))
		    | ((str_p("VALUE")) >> ItemNumber >> (GetItemInformation
							  % ch_p(',')));;;
		  GetHeaderInformation = SimpleTargetSpecification1 >> '='
								    >> HeaderItemName;;;
		  HeaderItemName = (str_p("COUNT")) | str_p("KEY_TYPE") | str_p(
										"DYNAMIC_FUNCTION") | str_p("DYNAMIC_FUNCTION_CODE")
		    | str_p("TOP_LEVEL_COUNT");;;
		  GetItemInformation = SimpleTargetSpecification2 >> '='
								  >> DescriptorItemName;;;
		  ...
		  DescriptorItemName = (str_p("CARDINALITY")) | str_p(
								      "CHARACTER_SET_CATALOG") | str_p("CHARACTER_SET_NAME")
		    | str_p("CHARACTER_SET_SCHEMA")
		    | str_p("COLLATION_CATALOG") | str_p("COLLATION_NAME")
		    | str_p("COLLATION_SCHEMA") | str_p("DATA") | str_p(
									"DATETIME_INTERVAL_CODE") | str_p(
													  "DATETIME_INTERVAL_PRECISION") | str_p("DEGREE") | str_p(
																				   "INDICATOR") | str_p("KEY_MEMBER") | str_p("LENGTH")
		    | str_p("LEVEL") | str_p("NAME") | str_p("NULLABLE")
		    | str_p("OCTET_LENGTH") | str_p("PARAMETER_MODE") | str_p(
									      "PARAMETER_ORDINAL_POSITION") | str_p(
														    "PARAMETER_SPECIFIC_CATALOG") | str_p(
																			  "PARAMETER_SPECIFIC_NAME") | str_p(
																							     "PARAMETER_SPECIFIC_SCHEMA") | str_p("PRECISION") | str_p(
																														       "RETURNED_CARDINALITY") | str_p("RETURNED_LENGTH") | str_p(
																																						  "RETURNED_OCTET_LENGTH") | str_p("SCALE") | str_p(
																																												    "SCOPE_CATALOG") | str_p("SCOPE_NAME") | str_p(
																																																		   "SCOPE_SCHEMA") | str_p("TYPE") | str_p("UNNAMED") | str_p(
																																																									      "USER_DEFINED_TYPE_CATALOG") | str_p(
																																																														   "USER_DEFINED_TYPE_NAME") | str_p(
																																																																		     "USER_DEFINED_TYPE_SCHEMA") | str_p(
																																																																							 "USER_DEFINED_TYPE_CODE");;;
		  SetDescriptorStatement = ((str_p("SET")) >> !(str_p("SQL"))
					    >> "DESCRIPTOR" >> DescriptorName
					    >> SetDescriptorInformation);;;
		  SetDescriptorInformation = ((SetHeaderInformation % ch_p(',')))
		    | ((str_p("VALUE")) >> ItemNumber >> (SetItemInformation
							  % ch_p(',')));;;
		  SetHeaderInformation = HeaderItemName >> '='
							>> SimpleValueSpecification1;;;
		  SetItemInformation = DescriptorItemName >> '='
		  ...
		  ItemNumber = SimpleValueSpecification;;;
		  PrepareStatement = ((str_p("PREPARE")) >> SQLStatementName
				      >> !AttributesSpecification >> "FROM"
				      >> SQLStatementVariable);;;
		  AttributesSpecification = (str_p("ATTRIBUTES"))
		    >> AttributesVariable;;;
		  ...
		  PreparableSQLDataStatement = DeleteStatementSearched
		    | DynamicSingleRowSelectStatement | InsertStatement
		    | DynamicSelectStatement | UpdateStatementSearched
		    | MergeStatement
		  ...
		  CursorAttribute = CursorSensitivity | CursorScrollability
		    | CursorHoldability | CursorReturnability;;;
		  DeallocatePreparedStatement = (str_p("DEALLOCATE")) >> "PREPARE"
								      >> SQLStatementName;;;
		  DescribeStatement = DescribeInputStatement
		    | DescribeOutputStatement;;;
		  DescribeInputStatement = ((str_p("DESCRIBE")) >> "INPUT"
					    >> SQLStatementName >> UsingDescriptor >> !NestingOption);;;
		  DescribeOutputStatement = ((str_p("DESCRIBE"))
					     >> !(str_p("OUTPUT")) >> DescribedObject >> UsingDescriptor
					     >> !NestingOption);;;
		  NestingOption = (str_p("WITH")) >> "NESTING" | str_p("WITHOUT")
						  >> "NESTING";;;
		  UsingDescriptor = ((str_p("USING")) >> !(str_p("SQL"))
				     >> "DESCRIPTOR" >> DescriptorName);;;
		  DescribedObject = SQLStatementName | str_p("CURSOR")
		    >> ExtendedCursorName >> "STRUCTURE";;;
		  ...
		  IntoDescriptor = ((str_p("INTO")) >> !(str_p("SQL"))
				    >> "DESCRIPTOR" >> DescriptorName);;;
		  ExecuteStatement = ((str_p("EXECUTE")) >> SQLStatementName
				      >> !ResultUsingClause >> !ParameterUsingClause);;;
		  ResultUsingClause = OutputUsingClause;;;
		  ParameterUsingClause = InputUsingClause;;;
		  ExecuteImmediateStatement = (str_p("EXECUTE")) >> "IMMEDIATE"
								 >> SQLStatementVariable;;;
		  DynamicDeclareCursor = ((str_p("DECLARE")) >> CursorName
					  >> !CursorSensitivity >> !CursorScrollability >> "CURSOR"
					  >> !CursorHoldability >> !CursorReturnability >> "FOR"
					  >> StatementName);;;
		  AllocateCursorStatement = (str_p("ALLOCATE")) >> ExtendedCursorName
								>> CursorIntent;;;
		  CursorIntent = StatementCursor | ResultSetCursor;;;
		  StatementCursor = !(CursorSensitivity >> !CursorScrollability
				      >> "CURSOR" >> !CursorHoldability >> !CursorReturnability
				      >> "FOR" >> ExtendedStatementName);;;
		  ResultSetCursor = (str_p("FOR")) >> "PROCEDURE"
						   >> SpecificRoutineDesignator;;;
		  DynamicOpenStatement = ((str_p("OPEN")) >> DynamicCursorName
					  >> !InputUsingClause);;;
		  DynamicFetchStatement = ((str_p("FETCH")) >> !!(FetchOrientation
								  >> "FROM") >> DynamicCursorName >> OutputUsingClause);;;
		  DynamicSingleRowSelectStatement = QuerySpecification;;;
		  DynamicCloseStatement = (str_p("CLOSE")) >> DynamicCursorName;;;
		  DynamicDeleteStatementPositioned = (str_p("DELETE")) >> "FROM"
								       >> TargetTable >> "WHERE" >> "CURRENT" >> "OF"
								       >> DynamicCursorName;;;
		  DynamicUpdateStatementPositioned = (str_p("UPDATE")) >> TargetTable
								       >> "SET" >> SetClauseList >> "WHERE" >> "CURRENT" >> "OF"
								       >> DynamicCursorName;;;
		  PreparableDynamicDeleteStatementPositioned = ((str_p("DELETE"))
								>> !(str_p("FROM")) >> TargetTable >> "WHERE" >> "CURRENT"
								>> "OF" >> !ScopeOption >> CursorName);;;
		  PreparableDynamicUpdateStatementPositioned = ((str_p("UPDATE"))
								>> !TargetTable >> "SET" >> SetClauseList >> "WHERE"
								>> "CURRENT" >> "OF" >> !ScopeOption >> CursorName);;;
		  EmbeddedSQLHostProgram = EmbeddedSQLAdaProgram
		    | EmbeddedSQLCProgram | EmbeddedSQLCOBOLProgram
		    | EmbeddedSQLFortranProgram | EmbeddedSQLMUMPSProgram
		    | EmbeddedSQLPascalProgram | EmbeddedSQLPLIProgram;;;
		  EmbeddedSQLStatement = (SQLPrefix >> StatementOrDeclaration
					  >> !SQLTerminator);;;
		  StatementOrDeclaration = DeclareCursor | DynamicDeclareCursor
		    ...
		    // | HandlerDeclaration  //
		    | SQLProcedureStatement;;;
		  SQLPrefix = str_p("EXEC") >> "SQL" | ch_p('&') >> "SQL" >> '(';;;
		  SQLTerminator = str_p("ENDEXEC") | ';' | ')';;;
		  EmbeddedAuthorizationDeclaration = (str_p("DECLARE"))
		    >> EmbeddedAuthorizationClause;;;
		  EmbeddedAuthorizationClause = (str_p("SCHEMA")) >> SchemaName
		    | ((str_p("AUTHORIZATION"))
		       >> EmbeddedAuthorizationIdentifier >> !((str_p(
								      "FOR")) >> "STATIC" >> "ONLY" | str_p("AND")
							       >> "DYNAMIC")) | ((str_p("SCHEMA")) >> SchemaName
										 >> "AUTHORIZATION" >> EmbeddedAuthorizationIdentifier
										 >> !((str_p("FOR")) >> "STATIC" >> "ONLY" | str_p("AND")
										      >> "DYNAMIC"));;;
		  ...
		  EmbeddedSQLDeclareSection = (EmbeddedSQLBeginDeclare
					       >> !EmbeddedCharacterSetDeclaration
					       >> *HostVariableDefinition >> EmbeddedSQLEndDeclare)
		    | EmbeddedSQLMUMPSDeclare;;;
		  EmbeddedCharacterSetDeclaration = (str_p("SQL")) >> "NAMES"
								   >> "ARE" >> CharacterSetSpecification;;;
		  EmbeddedSQLBeginDeclare = (SQLPrefix >> "BEGIN" >> "DECLARE"
					     >> "SECTION" >> !SQLTerminator);;;
		  EmbeddedSQLEndDeclare = (SQLPrefix >> "END" >> "DECLARE"
					   >> "SECTION" >> !SQLTerminator);;;
		  EmbeddedSQLMUMPSDeclare = nothing_p;;;
		  // (SQLPrefix  >> "BEGIN"   >> "DECLARE"   >> "SECTION"  >> !EmbeddedCharacterSetDeclaration >> +HostVariableDefinition)  >> "END"   >> "DECLARE"   >> "SECTION"  >> SQLTerminator);;;
		  HostVariableDefinition = AdaVariableDefinition
		    | CVariableDefinition | COBOLVariableDefinition
		    | FortranVariableDefinition | MUMPSVariableDefinition
		    | PascalVariableDefinition | PLIVariableDefinition;;;
		  EmbeddedVariableName = ch_p(':') >> HostIdentifier;;;
		  HostIdentifier = AdaHostIdentifier | CHostIdentifier
		    | COBOLHostIdentifier | FortranHostIdentifier
		    | MUMPSHostIdentifier | PascalHostIdentifier
		    | PLIHostIdentifier;;;
		  EmbeddedExceptionDeclaration = (str_p("WHENEVER")) >> Condition
								     >> ConditionAction;;;
		  Condition = SQLCondition;;;
		  SQLCondition = MajorCategory | str_p("SQLSTATE")
		    >> SQLSTATEClassValue >> !(ch_p(',')
					       >> SQLSTATESubclassValue) | str_p("CONSTRAINT")
		    >> ConstraintName;;;
		  MajorCategory = (str_p("SQLEXCEPTION")) | str_p("SQLWARNING")
		    | str_p("NOT") >> "FOUND";;;
		  SQLSTATEClassValue = SQLSTATEChar >> SQLSTATEChar;;;//nothing_p;;;
		  SQLSTATESubclassValue = SQLSTATEChar >> SQLSTATEChar
						       >> SQLSTATEChar;;;//fail_p;;;
		  SQLSTATEChar = upper_p | digit_p;;;
		  ConditionAction = (str_p("CONTINUE")) | GoTo;;;
		  GoTo = ((str_p("GOTO")) | str_p("GO") >> "TO" >> GotoTarget);;;
		  GotoTarget = HostLabelIdentifier | uint_p | HostPLILabelVariable;;;
		  HostLabelIdentifier = nothing_p;;;
		  HostPLILabelVariable = nothing_p;;;
		  EmbeddedSQLAdaProgram = nothing_p;;;
		  AdaVariableDefinition = ((AdaHostIdentifier % ch_p(',')) >> ':'
					   >> AdaTypeSpecification >> !AdaInitialValue);;;
		  AdaInitialValue = (AdaAssignmentOperator
		  ...
		  AdaDerivedTypeSpecification = AdaCLOBVariable
		    ...
		    | AdaUserDefinedTypeLocatorVariable | AdaREFVariable
		    | AdaArrayLocatorVariable | AdaMultisetLocatorVariable;;;
		  AdaCLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
				     >> '(' >> LargeObjectLength >> ')'
				     >> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					  >> CharacterSetSpecification));;;
		  AdaCLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
							  >> "AS" >> "LOCATOR";;;
		  AdaBLOBVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB" >> '('
						   >> LargeObjectLength >> ')';;;
		  AdaBLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
							  >> "AS" >> "LOCATOR";;;
		  AdaUserDefinedTypeVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> PathResolvedUserDefinedTypeName >> "AS"
							      >> PredefinedType;;;
		  AdaUserDefinedTypeLocatorVariable = (str_p("SQL")) >> "TYPE"
								     >> "IS" >> PathResolvedUserDefinedTypeName >> "AS"
								     >> "LOCATOR";;;
		  AdaREFVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> ReferenceType;;;
		  AdaArrayLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							   >> ArrayType >> "AS" >> "LOCATOR";;;
		  AdaMultisetLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> MultisetType >> "AS" >> "LOCATOR";;;
		  EmbeddedSQLCProgram = nothing_p;;;
		  CVariableDefinition = !(CStorageClass >> !CClassModifier
					  >> CVariableSpecification >> ';');;;
		  CVariableSpecification = CNumericVariable | CCharacterVariable
		    | CDerivedVariable;;;
		  CStorageClass = str_p("Auto") | "Extern" | "Static";;;
		  CClassModifier = str_p("const") | str_p("volatile");;;
		  CNumericVariable = (str_p("LONG") >> "LONG" | str_p("LONG")
				      | "SHORT" | "FLOAT" | "DOUBLE" >> CHostIdentifier
				      >> !CInitialValue >> *((ch_p(',') >> CHostIdentifier
							      >> !CInitialValue)));;;
		  CCharacterVariable = (CCharacterType >> !((str_p("CHARACTER"))
							    >> "SET" >> !(str_p("IS")) >> CharacterSetSpecification)
					>> CHostIdentifier >> CArraySpecification >> !CInitialValue
					>> *((ch_p(',') >> CHostIdentifier >> CArraySpecification
					      >> !CInitialValue)));;;
		  CCharacterType = str_p("CHAR") | str_p("UNSIGNED")
		    >> (str_p("CHAR") | "SHORT");;;
		  CArraySpecification = ch_p('{') >> Length >> '}';;;
		  CHostIdentifier = nothing_p;;;
		  CDerivedVariable = CVARCHARVariable | CNCHARVariable
		    | CNCHARVARYINGVariable | CCLOBVariable | CNCLOBVariable
		    | CBLOBVariable | CUserDefinedTypeVariable
		    | CCLOBLocatorVariable | CBLOBLocatorVariable
		    | CArrayLocatorVariable | CMultisetLocatorVariable
		    | CUserDefinedTypeLocatorVariable | CREFVariable;;;
		  CVARCHARVariable = ((str_p("VARCHAR")) >> !((str_p("CHARACTER"))
							      >> "SET" >> !(str_p("IS")) >> CharacterSetSpecification)
				      >> CHostIdentifier >> CArraySpecification >> !CInitialValue
				      >> *((ch_p(',') >> CHostIdentifier >> CArraySpecification
					    >> !CInitialValue)));;;
		  CNCHARVariable = ((str_p("NCHAR")) >> !((str_p("CHARACTER"))
							  >> "SET" >> !(str_p("IS")) >> CharacterSetSpecification)
				    >> CHostIdentifier >> CArraySpecification >> !CInitialValue
				    >> *((ch_p(',') >> CHostIdentifier >> CArraySpecification
					  >> !CInitialValue)));;;
		  CNCHARVARYINGVariable = ((str_p("NCHAR")) >> "VARYING" >> !((str_p(
										     "CHARACTER")) >> "SET" >> !(str_p("IS"))
									      >> CharacterSetSpecification) >> CHostIdentifier
					   >> CArraySpecification >> !CInitialValue
					   >> *((ch_p(',') >> CHostIdentifier >> CArraySpecification
						 >> !CInitialValue)));;;
		  ...
		  CNCLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "NCLOB"
				    ...
				    >> !CInitialValue >> *((ch_p(',') >> CHostIdentifier
							    >> !CInitialValue)));;;
		  CUserDefinedTypeVariable = ((str_p("SQL")) >> "TYPE" >> "IS"
					      >> PathResolvedUserDefinedTypeName >> "AS"
					      >> PredefinedType >> CHostIdentifier >> !CInitialValue
					      >> *((ch_p(',') >> CHostIdentifier >> !CInitialValue)));;;
		  CBLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB" >> '('
				   >> LargeObjectLength >> ')' >> CHostIdentifier
				   >> !CInitialValue >> *((ch_p(',') >> CHostIdentifier
							   >> !CInitialValue)));;;
		  CCLOBLocatorVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
					  >> "AS" >> "LOCATOR" >> CHostIdentifier >> !CInitialValue
					  >> *((ch_p(',') >> CHostIdentifier >> !CInitialValue)));;;
		  CBLOBLocatorVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
					  >> "AS" >> "LOCATOR" >> CHostIdentifier >> !CInitialValue
					  >> *((ch_p(',') >> CHostIdentifier >> !CInitialValue)));;;
		  CArrayLocatorVariable = ((str_p("SQL")) >> "TYPE" >> "IS"
					   >> ArrayType >> "AS" >> "LOCATOR" >> CHostIdentifier
					   >> !CInitialValue >> *((ch_p(',') >> CHostIdentifier
								   >> !CInitialValue)));;;
		  CMultisetLocatorVariable = ((str_p("SQL")) >> "TYPE" >> "IS"
					      >> MultisetType >> "AS" >> "LOCATOR" >> CHostIdentifier
					      >> !CInitialValue >> *((ch_p(',') >> CHostIdentifier
								      >> !CInitialValue)));;;
		  CUserDefinedTypeLocatorVariable = ((str_p("SQL")) >> "TYPE" >> "IS"
						     >> PathResolvedUserDefinedTypeName >> "AS" >> "LOCATOR"
						     >> CHostIdentifier >> !CInitialValue >> *((ch_p(',')
												>> CHostIdentifier >> !CInitialValue)));;;
		  CREFVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> ReferenceType;;;
		  CInitialValue = (ch_p('=') >> +CharacterRepresentation);;;
		  EmbeddedSQLCOBOLProgram = nothing_p;;;
		  COBOLVariableDefinition = nothing_p;;;// (01 | 77 >> COBOLHostIdentifier
					   //  >> COBOLTypeSpecification >> *CharacterRepresentation
					   //  >> '.');;;
		  COBOLHostIdentifier = nothing_p;;;
		  COBOLTypeSpecification = COBOLCharacterType
		    | COBOLNationalCharacterType | COBOLNumericType
		    | COBOLIntegerType | COBOLDerivedTypeSpecification;;;
		  COBOLDerivedTypeSpecification = COBOLCLOBVariable
		    | COBOLNCLOBVariable | COBOLBLOBVariable
		    | COBOLUserDefinedTypeVariable | COBOLCLOBLocatorVariable
		    | COBOLBLOBLocatorVariable | COBOLArrayLocatorVariable
		    | COBOLMultisetLocatorVariable
		    | COBOLUserDefinedTypeLocatorVariable | COBOLREFVariable;;;
		  COBOLCharacterType = !(((str_p("CHARACTER")) 
					  >> "SET" 
					  >> !(str_p( "IS"))
					  >> CharacterSetSpecification)
					 >> "PIC"
		  ...
		  COBOLBLOBVariable = !(((str_p("USAGE")) >> !(str_p("IS"))) >> "SQL"
					...
					>> ')');;;
		  COBOLUserDefinedTypeVariable = !(((str_p("USAGE"))
						    >> !(str_p("IS"))) >> "SQL" >> "TYPE" >> "IS"
						   >> PathResolvedUserDefinedTypeName >> "AS"
						   >> PredefinedType);;;
		  COBOLCLOBLocatorVariable = !(((str_p("USAGE")) >> !(str_p("IS")))
					       >> "SQL" >> "TYPE" >> "IS" >> "CLOB" >> "AS" >> "LOCATOR");;;
		  COBOLBLOBLocatorVariable = !(((str_p("USAGE")) >> !(str_p("IS")))
					       >> "SQL" >> "TYPE" >> "IS" >> "BLOB" >> "AS" >> "LOCATOR");;;
		  COBOLArrayLocatorVariable = !(((str_p("USAGE")) >> !(str_p("IS")))
						>> "SQL" >> "TYPE" >> "IS" >> ArrayType >> "AS"
						>> "LOCATOR");;;
		  COBOLMultisetLocatorVariable = !(((str_p("USAGE"))
						    >> !(str_p("IS"))) >> "SQL" >> "TYPE" >> "IS"
						   >> MultisetType >> "AS" >> "LOCATOR");;;
		  COBOLUserDefinedTypeLocatorVariable = !(((str_p("USAGE"))
							   >> !(str_p("IS"))) >> "SQL" >> "TYPE" >> "IS"
							  >> PathResolvedUserDefinedTypeName >> "AS" >> "LOCATOR");;;
		  COBOLREFVariable = !(((str_p("USAGE")) >> !(str_p("IS"))) >> "SQL"
				       >> "TYPE" >> "IS" >> ReferenceType);;;
		  COBOLNumericType = ("PIC" | str_p("PICTURE") >> !(str_p("IS"))
				      >> "S" >> COBOLNinesSpecification >> !((str_p("USAGE"))
									     >> !(str_p("IS"))) >> "DISPLAY" >> "SIGN" >> "LEADING"
				      >> "SEPARATE");;;
		  COBOLNinesSpecification = (COBOLNines >> !("V" >> !COBOLNines))
		    | str_p("V") >> COBOLNines;;;
		  COBOLIntegerType = COBOLBinaryInteger;;;
		  COBOLBinaryInteger = ("PIC" | str_p("PICTURE") >> !(str_p("IS"))
					>> "S" >> COBOLNines >> !((str_p("USAGE"))
								  >> !(str_p("IS"))) >> "BINARY");;;
		  COBOLNines = +(('9' >> !ch_p('(') >> Length >> ')'));;;
		  EmbeddedSQLFortranProgram = nothing_p;;;
		  FortranVariableDefinition = (FortranTypeSpecification
					       >> (FortranHostIdentifier % ch_p(',')));;;
		  FortranHostIdentifier = nothing_p;;;
		  FortranTypeSpecification = ((str_p("CHARACTER")) >> !ch_p('*')
					      >> Length >> !((str_p("CHARACTER")) >> "SET" >> !(str_p(
												      "IS")) >> CharacterSetSpecification)) | str_p("CHARACTER")
		    >> "broken KIND=" >> (/*n >>*/!ch_p('*') >> Length
					  >> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					       >> CharacterSetSpecification)) | str_p("INTEGER")
		    | str_p("REAL") | str_p("DOUBLE") >> "PRECISION" | str_p(
									     "LOGICAL") | FortranDerivedTypeSpecification;;;
		  FortranDerivedTypeSpecification = FortranCLOBVariable
		    | FortranBLOBVariable | FortranUserDefinedTypeVariable
		    | FortranCLOBLocatorVariable | FortranBLOBLocatorVariable
		    | FortranUserDefinedTypeLocatorVariable
		    | FortranArrayLocatorVariable
		    | FortranMultisetLocatorVariable | FortranREFVariable;;;
		  FortranCLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
					 >> '(' >> LargeObjectLength >> ')'
					 >> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					      >> CharacterSetSpecification));;;
		  FortranBLOBVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
						       >> '(' >> LargeObjectLength >> ')';;;
		  FortranUserDefinedTypeVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								  >> PathResolvedUserDefinedTypeName >> "AS"
								  >> PredefinedType;;;
		  FortranCLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> "CLOB" >> "AS" >> "LOCATOR";;;
		  FortranBLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> "BLOB" >> "AS" >> "LOCATOR";;;
		  FortranUserDefinedTypeLocatorVariable = (str_p("SQL")) >> "TYPE"
									 >> "IS" >> PathResolvedUserDefinedTypeName >> "AS"
									 >> "LOCATOR";;;
		  FortranArrayLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							       >> ArrayType >> "AS" >> "LOCATOR";;;
		  FortranMultisetLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								  >> MultisetType >> "AS" >> "LOCATOR";;;
		  FortranREFVariable = (str_p("SQL")) >> "TYPE" >> "IS"
						      >> ReferenceType;;;
		  ...
		  MUMPSCharacterVariable = ((str_p("VARCHAR")) >> MUMPSHostIdentifier
					    >> MUMPSLengthSpecification >> *(ch_p(',')
									     >> MUMPSHostIdentifier >> MUMPSLengthSpecification));;;
		  MUMPSHostIdentifier = nothing_p;;;
		  MUMPSLengthSpecification = ch_p('(') >> Length >> ')';;;
		  MUMPSNumericVariable = (MUMPSTypeSpecification
					  >> (MUMPSHostIdentifier % ch_p(',')));;;
		  MUMPSTypeSpecification = (str_p("INT")) | ((str_p("DEC"))
							     >> !(ch_p('(') >> Precision >> !ch_p(',') >> Scale >> ')'))
		    | str_p("REAL");;;
		  MUMPSDerivedTypeSpecification = MUMPSCLOBVariable
		    | MUMPSBLOBVariable | MUMPSUserDefinedTypeVariable
		    | MUMPSCLOBLocatorVariable | MUMPSBLOBLocatorVariable
		    | MUMPSUserDefinedTypeLocatorVariable
		    | MUMPSArrayLocatorVariable | MUMPSMultisetLocatorVariable
		    | MUMPSREFVariable;;;
		  MUMPSCLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
				       >> '(' >> LargeObjectLength >> ')'
				       >> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					    >> CharacterSetSpecification));;;
		  MUMPSBLOBVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
						     >> '(' >> LargeObjectLength >> ')';;;
		  MUMPSUserDefinedTypeVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								>> PathResolvedUserDefinedTypeName >> "AS"
								>> PredefinedType;;;
		  MUMPSCLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							    >> "CLOB" >> "AS" >> "LOCATOR";;;
		  MUMPSBLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							    >> "BLOB" >> "AS" >> "LOCATOR";;;
		  MUMPSUserDefinedTypeLocatorVariable = (str_p("SQL")) >> "TYPE"
								       >> "IS" >> PathResolvedUserDefinedTypeName >> "AS"
								       >> "LOCATOR";;;
		  MUMPSArrayLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							     >> ArrayType >> "AS" >> "LOCATOR";;;
		  MUMPSMultisetLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								>> MultisetType >> "AS" >> "LOCATOR";;;
		  MUMPSREFVariable = (str_p("SQL")) >> "TYPE" >> "IS"
						    >> ReferenceType;;;
		  EmbeddedSQLPascalProgram = nothing_p;;;
		  PascalVariableDefinition = ((PascalHostIdentifier % ch_p(','))
					      >> ':' >> PascalTypeSpecification >> ';');;;
		  PascalHostIdentifier = nothing_p;;;
		  PascalTypeSpecification = (str_p("PACKED") >> "ARRAY" >> '{' >> '1'
					     >> ".." >> Length >> '}' >> "OF" >> "CHAR" >> !((str_p(
												    "CHARACTER")) >> "SET" >> !(str_p("IS"))
											     >> CharacterSetSpecification)) | str_p("INTEGER") | str_p(
																		       "REAL") | ((str_p("CHAR")) >> !((str_p("CHARACTER"))
																						       >> "SET" >> !(str_p("IS")) >> CharacterSetSpecification))
		    | str_p("BOOLEAN") | PascalDerivedTypeSpecification;;;
		  PascalDerivedTypeSpecification = PascalCLOBVariable
		    | PascalBLOBVariable | PascalUserDefinedTypeVariable
		    | PascalCLOBLocatorVariable | PascalBLOBLocatorVariable
		    | PascalUserDefinedTypeLocatorVariable
		    | PascalArrayLocatorVariable
		    | PascalMultisetLocatorVariable | PascalREFVariable;;;
		  PascalCLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
					>> '(' >> LargeObjectLength >> ')'
					>> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					     >> CharacterSetSpecification));;;
		  PascalBLOBVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
						      >> '(' >> LargeObjectLength >> ')';;;
		  PascalCLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							     >> "CLOB" >> "AS" >> "LOCATOR";;;
		  PascalUserDefinedTypeVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								 >> PathResolvedUserDefinedTypeName >> "AS"
								 >> PredefinedType;;;
		  PascalBLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							     >> "BLOB" >> "AS" >> "LOCATOR";;;
		  PascalUserDefinedTypeLocatorVariable = (str_p("SQL")) >> "TYPE"
									>> "IS" >> PathResolvedUserDefinedTypeName >> "AS"
									>> "LOCATOR";;;
		  PascalArrayLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> ArrayType >> "AS" >> "LOCATOR";;;
		  PascalMultisetLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
								 >> MultisetType >> "AS" >> "LOCATOR";;;
		  PascalREFVariable = (str_p("SQL")) >> "TYPE" >> "IS"
						     >> ReferenceType;;;
		  EmbeddedSQLPLIProgram = nothing_p;;;
		  PLIVariableDefinition = (str_p("DCL") | str_p("DECLARE")
					   >> PLIHostIdentifier | (ch_p('(') >> (PLIHostIdentifier
										 % ch_p(',')) >> ')') >> PLITypeSpecification
					   >> *CharacterRepresentation >> ';');;;
		  PLIHostIdentifier = nothing_p;;;
		  PLITypeSpecification = ((str_p("CHAR")) | str_p("CHARACTER")
					  >> !(str_p("VARYING")) >> '(' >> Length >> ')' >> !((str_p(
												     "CHARACTER")) >> "SET" >> !(str_p("IS"))
											      >> CharacterSetSpecification)) | (PLITypeFixedDecimal
																>> '(' >> Precision >> !ch_p(',') >> Scale >> ')')
		    | (PLITypeFixedBinary >> !ch_p('(') >> Precision >> ')')
		    | PLITypeFloatBinary >> '(' >> Precision >> ')'
		    | PLIDerivedTypeSpecification;;;
		  PLIDerivedTypeSpecification = PLICLOBVariable | PLIBLOBVariable
		    | PLIUserDefinedTypeVariable | PLICLOBLocatorVariable
		    | PLIBLOBLocatorVariable
		    | PLIUserDefinedTypeLocatorVariable
		    | PLIArrayLocatorVariable | PLIMultisetLocatorVariable
		    | PLIREFVariable;;;
		  PLICLOBVariable = ((str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
				     >> '(' >> LargeObjectLength >> ')'
				     >> !((str_p("CHARACTER")) >> "SET" >> !(str_p("IS"))
					  >> CharacterSetSpecification));;;
		  PLIBLOBVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB" >> '('
						   >> LargeObjectLength >> ')';;;
		  PLIUserDefinedTypeVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> PathResolvedUserDefinedTypeName >> "AS"
							      >> PredefinedType;;;
		  PLICLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "CLOB"
							  >> "AS" >> "LOCATOR";;;
		  PLIBLOBLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> "BLOB"
							  >> "AS" >> "LOCATOR";;;
		  PLIUserDefinedTypeLocatorVariable = (str_p("SQL")) >> "TYPE"
								     >> "IS" >> PathResolvedUserDefinedTypeName >> "AS"
								     >> "LOCATOR";;;
		  PLIArrayLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							   >> ArrayType >> "AS" >> "LOCATOR";;;
		  PLIMultisetLocatorVariable = (str_p("SQL")) >> "TYPE" >> "IS"
							      >> MultisetType >> "AS" >> "LOCATOR";;;
		  PLIREFVariable = (str_p("SQL")) >> "TYPE" >> "IS" >> ReferenceType;;;
		  PLITypeFixedDecimal
		    = ((str_p("DEC")) | str_p("DECIMAL") >> "FIXED") | (str_p(
									      "FIXED") >> "DEC" | str_p("DECIMAL"));;;
		  PLITypeFixedBinary = (str_p("BIN") | str_p("BINARY") >> "FIXED")
		    | (str_p("FIXED") >> "BIN" | str_p("BINARY"));;;
		  PLITypeFloatBinary = (str_p("BIN") | str_p("BINARY") >> "FLOAT")
		    | ((str_p("FLOAT")) >> "BIN" | str_p("BINARY"));;;

		  DirectSQLStatement = DirectlyExecutableStatement >> ';';;;
		  DirectlyExecutableStatement = DirectSQLDataStatement
		    | SQLSchemaStatement | SQLTransactionStatement
		    | SQLConnectionStatement | SQLSessionStatement
		    | DirectImplementationDefinedStatement;;;
		  DirectSQLDataStatement = DeleteStatementSearched
		    | DirectSelectStatementMultipleRows | InsertStatement
		    | UpdateStatementSearched | MergeStatement
		    | TemporaryTableDeclaration;;;
		  DirectImplementationDefinedStatement = nothing_p;;;
		  DirectSelectStatementMultipleRows = CursorSpecification;;;
		  GetDiagnosticsStatement = (str_p("GET")) >> "DIAGNOSTICS"
		  ...
		  StatementInformationItem = SimpleTargetSpecification >> '='
								       >> StatementInformationItemName;;;
		  StatementInformationItemName = (str_p("NUMBER")) | str_p("MORE")
		    | str_p("COMMAND_FUNCTION")
		    | str_p("COMMAND_FUNCTION_CODE")
		    | str_p("DYNAMIC_FUNCTION")
		    | str_p("DYNAMIC_FUNCTION_CODE") | str_p("ROW_COUNT")
		    | str_p("TRANSACTIONS_COMMITTED") | str_p(
							      "TRANSACTIONS_ROLLED_BACK") | str_p("TRANSACTION_ACTIVE");;;
		  ConditionNumber = uint_p;;;
		  ConditionInformation = ((str_p("EXCEPTION")) | str_p("CONDITION")
					  >> ConditionNumber
					  >> (ConditionInformationItem % ch_p(',')));;;
		  ConditionInformationItem = SimpleTargetSpecification >> '='
								       >> ConditionInformationItemName;;;
		  ConditionInformationItemName = (str_p("CATALOG_NAME")) | str_p(
										 "CLASS_ORIGIN") | str_p("COLUMN_NAME") | str_p(
																"CONDITION_NUMBER") | str_p("CONNECTION_NAME") | str_p(
																						       "CONSTRAINT_CATALOG") | str_p("CONSTRAINT_NAME") | str_p(
																														"CONSTRAINT_SCHEMA") | str_p("CURSOR_NAME") | str_p(
																																				    "MESSAGE_LENGTH") | str_p("MESSAGE_OCTET_LENGTH") | str_p(
																																											      "MESSAGE_TEXT") | str_p("PARAMETER_MODE") | str_p(
																																																		"PARAMETER_NAME") | str_p("PARAMETER_ORDINAL_POSITION")
		    | str_p("RETURNED_SQLSTATE") | str_p("ROUTINE_CATALOG")
		    | str_p("ROUTINE_NAME") | str_p("ROUTINE_SCHEMA") | str_p(
									      "SCHEMA_NAME") | str_p("SERVER_NAME") | str_p(
															    "SPECIFIC_NAME") | str_p("SUBCLASS_ORIGIN") | str_p(
																						"TABLE_NAME") | str_p("TRIGGER_CATALOG") | str_p(
																												 "TRIGGER_NAME") | str_p("TRIGGER_SCHEMA");;;
		...
		rule<ScannerT> NondelimiterToken, SQLTerminalCharacter,
				SqlSpecialCharacters, Token,

				RegularIdentifier, IdentifierBody, IdentifierPart,
				IdentifierStart, IdentifierExtend, LargeObjectLengthToken,
				Multiplier, DelimitedIdentifier, UnicodeDelimitedIdentifier,
				UnicodeDelimiterBody, UnicodeIdentifierPart,
				UnicodeEscapeValue, Unicode4DigitEscapeValue,
				Unicode6DigitEscapeValue, NondoublequoteCharacter,
				DoublequoteSymbol, DelimiterToken, NotEqualsOperator,
				GreaterThanOrEqualsOperator, LessThanOrEqualsOperator,
				ConcatenationOperator, Separator, Comment, SimpleComment,
				SimpleCommentIntroducer, BracketedComment,
				BracketedCommentIntroducer, BracketedCommentTerminator,
				BracketedCommentContents, CommentCharacter, KeyWord,
				NonReservedWord, ReservedWord, Literal, UnsignedLiteral,
				GeneralLiteral, CharacterStringLiteral, Introducer,
				CharacterRepresentation, NonquoteCharacter, QuoteSymbol,
				NationalCharacterStringLiteral, UnicodeCharacterStringLiteral,
				UnicodeRepresentation, BinaryStringLiteral,
				SignedNumericLiteral, UnsignedNumericLiteral,
				ExactNumericLiteral, ApproximateNumericLiteral, Mantissa,
				Exponent, SignedInteger, DatetimeLiteral, DateLiteral,
				TimeLiteral, TimestampLiteral, DateString, TimeString,
				TimestampString, TimeZoneInterval, DateValue, TimeValue,
				IntervalLiteral, IntervalString, UnquotedDateString,
				UnquotedTimeString, UnquotedTimestampString,
				UnquotedIntervalString, YearMonthLiteral, DayTimeLiteral,
				DayTimeInterval, TimeInterval, YearsValue, MonthsValue,
				DaysValue, HoursValue, MinutesValue, SecondsValue,
				SecondsIntegerValue, SecondsFraction, DatetimeValue,
				BooleanLiteral, Identifier, ActualIdentifier,
				SQLLanguageIdentifier, SQLLanguageIdentifierStart,
				SQLLanguageIdentifierPart, AuthorizationIdentifier, TableName,
				DomainName, SchemaName, CatalogName, SchemaQualifiedName,
				LocalOrSchemaQualifiedName, LocalOrSchemaQualifier,
				QualifiedIdentifier, ColumnName, CorrelationName, QueryName,
				SQLClientModuleName, ProcedureName, SchemaQualifiedRoutineName,
				MethodName, SpecificName, CursorName, LocalQualifiedName,
				LocalQualifier, HostParameterName, SQLParameterName,
				ConstraintName, ExternalRoutineName, TriggerName,
				CollationName, CharacterSetName, TransliterationName,
				TranscodingName, UserDefinedTypeName,
				SchemaResolvedUserDefinedTypeName, SchemaQualifiedTypeName,
				AttributeName, FieldName, SavepointName, SequenceGeneratorName,
				RoleName, UserIdentifier, ConnectionName, SQLServerName,
				ConnectionUserName, SQLStatementName, StatementName,
				ExtendedStatementName, DynamicCursorName, ExtendedCursorName,
				DescriptorName, ScopeOption, WindowName, DataType,
				PredefinedType, CharacterStringType,
				NationalCharacterStringType, BinaryLargeObjectStringType,
				NumericType, ExactNumericType, ApproximateNumericType, Length,
				LargeObjectLength, CharLengthUnits, Precision, Scale,
				BooleanType, DatetimeType, WithOrWithoutTimeZone,
				TimePrecision, TimestampPrecision,
				TimeFractionalSecondsPrecision, IntervalType, RowType,
				RowTypeBody, ReferenceType, ScopeClause, ReferencedType,
				PathResolvedUserDefinedTypeName, CollectionType, ArrayType,
				MultisetType, FieldDefinition, ValueExpressionPrimary,
				ParenthesizedValueExpression,
				NonparenthesizedValueExpressionPrimary, ValueSpecification,
				UnsignedValueSpecification, GeneralValueSpecification,
				SimpleValueSpecification, TargetSpecification,
				SimpleTargetSpecification, HostParameterSpecification,
				DynamicParameterSpecification, EmbeddedVariableSpecification,
				IndicatorVariable, IndicatorParameter,
				TargetArrayElementSpecification, TargetArrayReference,
				CurrentCollationSpecification,
				ContextuallyTypedValueSpecification,
				ImplicitlyTypedValueSpecification, NullSpecification,
				EmptySpecification, DefaultSpecification, IdentifierChain,
				BasicIdentifierChain, ColumnReference, SQLParameterReference,
				SetFunctionSpecification, GroupingOperation, WindowFunction,
				WindowFunctionType, RankFunctionType,
				WindowNameOrSpecification, InLineWindowSpecification,
				CaseExpression, CaseAbbreviation, CaseSpecification,
				SimpleCase, SearchedCase, SimpleWhenClause, SearchedWhenClause,
				ElseClause, CaseOperand, WhenOperand, Result, ResultExpression,
				CastSpecification, CastOperand, CastTarget,
				NextValueExpression, FieldReference, SubtypeTreatment,
				SubtypeOperand, TargetSubtype, MethodInvocation,
				DirectInvocation, GeneralizedInvocation, MethodSelection,
				ConstructorMethodSelection, StaticMethodInvocation,
				StaticMethodSelection, NewSpecification, NewInvocation,
				AttributeOrMethodReference, DereferenceOperator,
				DereferenceOperation, MethodReference, ReferenceResolution,
				ArrayElementReference, MultisetElementReference,
				ValueExpression, CommonValueExpression,
				UserDefinedTypeValueExpression, ReferenceValueExpression,
				CollectionValueExpression, CollectionValueConstructor,
				NumericValueExpression, Term, Factor, NumericPrimary,
				NumericValueFunction, PositionExpression,
				StringPositionExpression, BlobPositionExpression,
				LengthExpression, CharLengthExpression, OctetLengthExpression,
				ExtractExpression, ExtractField, TimeZoneField, ExtractSource,
				CardinalityExpression, AbsoluteValueExpression,
				ModulusExpression, NaturalLogarithm, ExponentialFunction,
				PowerFunction, NumericValueExpressionBase,
				NumericValueExpressionExponent, SquareRoot, FloorFunction,
				CeilingFunction, WidthBucketFunction, WidthBucketOperand,
				WidthBucketBound1, WidthBucketBound2, WidthBucketCount,
				StringValueExpression, CharacterValueExpression, Concatenation,
				CharacterFactor, CharacterPrimary, BlobValueExpression,
				BlobFactor, BlobPrimary, BlobConcatenation,
				StringValueFunction, CharacterValueFunction,
				CharacterSubstringFunction, RegularExpressionSubstringFunction,
				Fold, Transcoding, CharacterTransliteration, TrimFunction,
				TrimOperands, TrimSource, TrimSpecification, TrimCharacter,
				CharacterOverlayFunction, NormalizeFunction,
				SpecificTypeMethod, BlobValueFunction, BlobSubstringFunction,
				BlobTrimFunction, BlobTrimOperands, BlobTrimSource, TrimOctet,
				BlobOverlayFunction, StartPosition, StringLength,
				DatetimeValueExpression, DatetimeTerm, DatetimeFactor,
				DatetimePrimary, TimeZone, TimeZoneSpecifier,
				DatetimeValueFunction, CurrentDateValueFunction,
				CurrentTimeValueFunction, CurrentLocalTimeValueFunction,
				CurrentTimestampValueFunction,
				CurrentLocalTimestampValueFunction, IntervalValueExpression,
				IntervalTerm, IntervalFactor, IntervalPrimary,
				IntervalValueExpression1, IntervalTerm1, IntervalTerm2,
				IntervalValueFunction, IntervalAbsoluteValueFunction,
				BooleanValueExpression, BooleanTerm, BooleanFactor,
				BooleanTest, TruthValue, BooleanPrimary, BooleanPredicand,
				ParenthesizedBooleanValueExpression, ArrayValueExpression,
				ArrayConcatenation, ArrayValueExpression1, ArrayFactor,
				ArrayValueConstructor, ArrayValueConstructorByEnumeration,
				ArrayElementList, ArrayElement, ArrayValueConstructorByQuery,
				MultisetValueExpression, MultisetTerm, MultisetPrimary,
				MultisetValueFunction, MultisetSetFunction,
				MultisetValueConstructor,
				MultisetValueConstructorByEnumeration, MultisetElementList,
				MultisetElement, MultisetValueConstructorByQuery,
				TableValueConstructorByQuery, RowValueConstructor,
				ExplicitRowValueConstructor, RowValueConstructorElementList,
				RowValueConstructorElement,
				ContextuallyTypedRowValueConstructor,
				ContextuallyTypedRowValueConstructorElementList,
				ContextuallyTypedRowValueConstructorElement,
				RowValueConstructorPredicand, RowValueExpression,
				TableRowValueExpression, ContextuallyTypedRowValueExpression,
				RowValuePredicand, RowValueSpecialCase, TableValueConstructor,
				RowValueExpressionList, ContextuallyTypedTableValueConstructor,
				ContextuallyTypedRowValueExpressionList, TableExpression,
				FromClause, TableReferenceList, TableReference,
				TablePrimaryOrJoinedTable, SampleClause, SampleMethod,
				RepeatableClause, SamplePercentage, RepeatArgument,
				TablePrimary, OnlySpec, LateralDerivedTable,
				CollectionDerivedTable, TableFunctionDerivedTable,
				DerivedTable, TableOrQueryName, DerivedColumnList,
				ColumnNameList, JoinedTable, CrossJoin, QualifiedJoin,
				NaturalJoin, UnionJoin, JoinSpecification, JoinCondition,
				NamedColumnsJoin, JoinType, OuterJoinType, JoinColumnList,
				WhereClause, GroupByClause, GroupingElementList,
				GroupingElement, OrdinaryGroupingSet, GroupingColumnReference,
				GroupingColumnReferenceList, RollupList,
				OrdinaryGroupingSetList, CubeList, GroupingSetsSpecification,
				GroupingSetList, GroupingSet, EmptyGroupingSet, HavingClause,
				WindowClause, WindowDefinitionList, WindowDefinition,
				NewWindowName, WindowSpecification, WindowSpecificationDetails,
				ExistingWindowName, WindowPartitionClause,
				WindowPartitionColumnReferenceList,
				WindowPartitionColumnReference, WindowOrderClause,
				WindowFrameClause, WindowFrameUnits, WindowFrameExtent,
				WindowFrameStart, WindowFramePreceding, WindowFrameBetween,
				WindowFrameBound1, WindowFrameBound2, WindowFrameBound,
				WindowFrameFollowing, WindowFrameExclusion, QuerySpecification,
				SelectList, SelectSublist, QualifiedAsterisk,
				AsteriskedIdentifierChain, AsteriskedIdentifier, DerivedColumn,
				AsClause, AllFieldsReference, AllFieldsColumnNameList,
				QueryExpression, WithClause, WithList, WithListElement,
				WithColumnList, QueryExpressionBody, NonJoinQueryExpression,
				QueryTerm, NonJoinQueryTerm, QueryPrimary, NonJoinQueryPrimary,
				SimpleTable, ExplicitTable, CorrespondingSpec,
				CorrespondingColumnList, SearchOrCycleClause, SearchClause,
				RecursiveSearchOrder, SequenceColumn, CycleClause,
				CycleColumnList, CycleColumn, CycleMarkColumn, PathColumn,
				CycleMarkValue, NonCycleMarkValue, ScalarSubquery, RowSubquery,
				TableSubquery, Subquery, Predicate, ComparisonPredicate,
				ComparisonPredicatePart2, CompOp, BetweenPredicate,
				BetweenPredicatePart2, InPredicate, InPredicatePart2,
				InPredicateValue, InValueList, LikePredicate,
				CharacterLikePredicate, CharacterLikePredicatePart2,
				CharacterPattern, EscapeCharacter, OctetLikePredicate,
				OctetLikePredicatePart2, OctetPattern, EscapeOctet,
				SimilarPredicate, SimilarPredicatePart2, SimilarPattern,
				RegularExpression, RegularTerm, RegularFactor, RepeatFactor,
				UpperLimit, LowValue, HighValue, RegularPrimary,
				CharacterSpecifier, NonEscapedCharacter, EscapedCharacter,
				RegularCharacterSet, CharacterEnumerationInclude,
				CharacterEnumerationExclude, CharacterEnumeration,
				RegularCharacterSetIdentifier, NullPredicate,
				NullPredicatePart2, QuantifiedComparisonPredicate,
				QuantifiedComparisonPredicatePart2, Quantifier, All, Some,
				ExistsPredicate, UniquePredicate, NormalizedPredicate,
				MatchPredicate, MatchPredicatePart2, OverlapsPredicate,
				OverlapsPredicatePart1, OverlapsPredicatePart2,
				RowValuePredicand1, RowValuePredicand2, DistinctPredicate,
				DistinctPredicatePart2, RowValuePredicand3, RowValuePredicand4,
				MemberPredicate, MemberPredicatePart2, SubmultisetPredicate,
				SubmultisetPredicatePart2, SetPredicate, SetPredicatePart2,
				TypePredicate, TypePredicatePart2, TypeList,
				UserDefinedTypeSpecification,
				InclusiveUserDefinedTypeSpecification,
				ExclusiveUserDefinedTypeSpecification, SearchCondition,
				IntervalQualifier, StartField, EndField, SingleDatetimeField,
				PrimaryDatetimeField, NonSecondPrimaryDatetimeField,
				IntervalFractionalSecondsPrecision,
				IntervalLeadingFieldPrecision, LanguageClause, LanguageName,
				PathSpecification, SchemaNameList, RoutineInvocation,
				RoutineName, SQLArgumentList, SQLArgument,
				GeneralizedExpression, CharacterSetSpecification,
				StandardCharacterSetName,
				ImplementationDefinedCharacterSetName,
				UserDefinedCharacterSetName, SpecificRoutineDesignator,
				RoutineType, MemberName, MemberNameAlternatives, DataTypeList,
				CollateClause, ConstraintNameDefinition,
				ConstraintCharacteristics, ConstraintCheckTime,
				AggregateFunction, GeneralSetFunction, SetFunctionType,
				ComputationalOperation, SetQuantifier, FilterClause,
				BinarySetFunction, BinarySetFunctionType,
				DependentVariableExpression, IndependentVariableExpression,
				OrderedSetFunction, HypotheticalSetFunction,
				WithinGroupSpecification,
				HypotheticalSetFunctionValueExpressionList,
				InverseDistributionFunction,
				InverseDistributionFunctionArgument,
				InverseDistributionFunctionType, SortSpecificationList,
				SortSpecification, SortKey, OrderingSpecification,
				NullOrdering, SchemaDefinition, SchemaCharacterSetOrPath,
				SchemaNameClause, SchemaAuthorizationIdentifier,
				SchemaCharacterSetSpecification, SchemaPathSpecification,
				SchemaElement, DropSchemaStatement, DropBehavior,
				TableDefinition, TableContentsSource, TableScope,
				GlobalOrLocal, TableCommitAction, TableElementList,
				TableElement, SelfReferencingColumnSpecification,
				ReferenceGeneration, SelfReferencingColumnName, ColumnOptions,
				ColumnOptionList, SubtableClause, SupertableClause,
				SupertableName, LikeClause, LikeOptions, IdentityOption,
				ColumnDefaultOption, AsSubqueryClause, WithOrWithoutData,
				ColumnDefinition, ColumnConstraintDefinition, ColumnConstraint,
				ReferenceScopeCheck, ReferenceScopeCheckAction,
				IdentityColumnSpecification, GenerationClause, GenerationRule,
				GenerationExpression, DefaultClause, DefaultOption,
				TableConstraintDefinition, TableConstraint,
				UniqueConstraintDefinition, UniqueSpecification,
				UniqueColumnList, ReferentialConstraintDefinition,
				ReferencesSpecification, MatchType, ReferencingColumns,
				ReferencedTableAndColumns, ReferenceColumnList,
				ReferentialTriggeredAction, UpdateRule, DeleteRule,
				ReferentialAction, CheckConstraintDefinition,
				AlterTableStatement, AlterTableAction, AddColumnDefinition,
				AlterColumnDefinition, AlterColumnAction,
				SetColumnDefaultClause, DropColumnDefaultClause,
				AddColumnScopeClause, DropColumnScopeClause,
				AlterIdentityColumnSpecification, AlterIdentityColumnOption,
				DropColumnDefinition, AddTableConstraintDefinition,
				DropTableConstraintDefinition, DropTableStatement,
				ViewDefinition, ViewSpecification, RegularViewSpecification,
				ReferenceableViewSpecification, SubviewClause, ViewElementList,
				ViewElement, ViewColumnOption, LevelsClause, ViewColumnList,
				DropViewStatement, DomainDefinition, DomainConstraint,
				AlterDomainStatement, AlterDomainAction,
				SetDomainDefaultClause, DropDomainDefaultClause,
				AddDomainConstraintDefinition, DropDomainConstraintDefinition,
				DropDomainStatement, CharacterSetDefinition,
				CharacterSetSource, DropCharacterSetStatement,
				CollationDefinition, ExistingCollationName, PadCharacteristic,
				DropCollationStatement, TransliterationDefinition,
				SourceCharacterSetSpecification,
				TargetCharacterSetSpecification, TransliterationSource,
				ExistingTransliterationName, TransliterationRoutine,
				DropTransliterationStatement, AssertionDefinition,
				DropAssertionStatement, TriggerDefinition, TriggerActionTime,
				TriggerEvent, TriggerColumnList, TriggeredAction,
				TriggeredSQLStatement, OldOrNewValuesAliasList,
				OldOrNewValuesAlias, OldValuesTableAlias, NewValuesTableAlias,
				OldValuesCorrelationName, NewValuesCorrelationName,
				DropTriggerStatement, UserDefinedTypeDefinition,
				UserDefinedTypeBody, UserDefinedTypeOptionList,
				UserDefinedTypeOption, SubtypeClause, SupertypeName,
				Representation, MemberList, Member, InstantiableClause,
				Finality, ReferenceTypeSpecification,
				UserDefinedRepresentation, DerivedRepresentation,
				SystemGeneratedRepresentation, RefCastOption, CastToRef,
				CastToRefIdentifier, CastToType, CastToTypeIdentifier,
				ListOfAttributes, CastOption, CastToDistinct,
				CastToDistinctIdentifier, CastToSource, CastToSourceIdentifier,
				MethodSpecificationList, MethodSpecification,
				OriginalMethodSpecification, OverridingMethodSpecification,
				PartialMethodSpecification, SpecificMethodName,
				MethodCharacteristics, MethodCharacteristic,
				AttributeDefinition, AttributeDefault, AlterTypeStatement,
				AlterTypeAction, AddAttributeDefinition,
				DropAttributeDefinition, AddOriginalMethodSpecification,
				AddOverridingMethodSpecification, DropMethodSpecification,
				SpecificMethodSpecificationDesignator, DropDataTypeStatement,
				SQLInvokedRoutine, SchemaRoutine, SchemaProcedure,
				SchemaFunction, SQLInvokedProcedure, SQLInvokedFunction,
				SQLParameterDeclarationList, SQLParameterDeclaration,
				ParameterMode, ParameterType, LocatorIndication,
				FunctionSpecification, MethodSpecificationDesignator,
				RoutineCharacteristics, RoutineCharacteristic,
				SavepointLevelIndication, DynamicResultSetsCharacteristic,
				ParameterStyleClause, DispatchClause, ReturnsClause,
				ReturnsType, ReturnsTableType, TableFunctionColumnList,
				TableFunctionColumnListElement, ResultCast, ResultCastFromType,
				ReturnsDataType, RoutineBody, SQLRoutineSpec, RightsClause,
				SQLRoutineBody, ExternalBodyReference, ExternalSecurityClause,
				ParameterStyle, DeterministicCharacteristic,
				SQLDataAccessIndication, NullCallClause,
				MaximumDynamicResultSets, TransformGroupSpecification,
				SingleGroupSpecification, MultipleGroupSpecification,
				GroupSpecification, AlterRoutineStatement,
				AlterRoutineCharacteristics, AlterRoutineCharacteristic,
				AlterRoutineBehavior, DropRoutineStatement,
				UserDefinedCastDefinition, CastFunction, SourceDataType,
				TargetDataType, DropUserDefinedCastStatement,
				UserDefinedOrderingDefinition, OrderingForm,
				EqualsOrderingForm, FullOrderingForm, OrderingCategory,
				RelativeCategory, MapCategory, StateCategory,
				RelativeFunctionSpecification, MapFunctionSpecification,
				DropUserDefinedOrderingStatement, TransformDefinition,
				TransformGroup, GroupName, TransformElementList,
				TransformElement, ToSql, FromSql, ToSqlFunction,
				FromSqlFunction, AlterTransformStatement, AlterGroup,
				AlterTransformActionList, AlterTransformAction,
				AddTransformElementList, DropTransformElementList,
				TransformKind, DropTransformStatement, TransformsToBeDropped,
				TransformGroupElement, SequenceGeneratorDefinition,
				SequenceGeneratorOptions, SequenceGeneratorOption,
				CommonSequenceGeneratorOptions, CommonSequenceGeneratorOption,
				BasicSequenceGeneratorOption, SequenceGeneratorDataTypeOption,
				SequenceGeneratorStartWithOption, SequenceGeneratorStartValue,
				SequenceGeneratorIncrementByOption, SequenceGeneratorIncrement,
				SequenceGeneratorMaxvalueOption, SequenceGeneratorMaxValue,
				SequenceGeneratorMinvalueOption, SequenceGeneratorMinValue,
				SequenceGeneratorCycleOption, AlterSequenceGeneratorStatement,
				AlterSequenceGeneratorOptions, AlterSequenceGeneratorOption,
				AlterSequenceGeneratorRestartOption,
				SequenceGeneratorRestartValue, DropSequenceGeneratorStatement,
				GrantStatement, GrantPrivilegeStatement, Privileges,
				ObjectName, ObjectPrivileges, Action, PrivilegeMethodList,
				PrivilegeColumnList, Grantee, Grantor, RoleDefinition,
				GrantRoleStatement, RoleGranted, DropRoleStatement,
				RevokeStatement, RevokePrivilegeStatement,
				RevokeOptionExtension, RevokeRoleStatement, RoleRevoked,
				SQLClientModuleDefinition, ModuleAuthorizationClause,
				ModuleAuthorizationIdentifier, ModulePathSpecification,
				ModuleTransformGroupSpecification, ModuleCollations,
				ModuleCollationSpecification, ModuleContents, ModuleNameClause,
				ModuleCharacterSetSpecification, ExternallyInvokedProcedure,
				HostParameterDeclarationList, HostParameterDeclaration,
				HostParameterDataType, StatusParameter, SQLProcedureStatement,
				SQLExecutableStatement, SQLSchemaStatement,
				SQLSchemaDefinitionStatement, SQLSchemaManipulationStatement,
				SQLDataStatement, SQLDataChangeStatement, SQLControlStatement,
				SQLTransactionStatement, SQLConnectionStatement,
				SQLSessionStatement, SQLDiagnosticsStatement,
				SQLDynamicStatement, SQLDynamicDataStatement,
				SystemDescriptorStatement, DeclareCursor, CursorSensitivity,
				CursorScrollability, CursorHoldability, CursorReturnability,
				CursorSpecification, UpdatabilityClause, OrderByClause,
				OpenStatement, FetchStatement, FetchOrientation,
				FetchTargetList, CloseStatement, SelectStatementSingleRow,
				SelectTargetList, DeleteStatementPositioned, TargetTable,
				DeleteStatementSearched, InsertStatement, InsertionTarget,
				InsertColumnsAndSource, FromSubquery, FromConstructor,
				OverrideClause, FromDefault, InsertColumnList, MergeStatement,
				MergeCorrelationName, MergeOperationSpecification,
				MergeWhenClause, MergeWhenMatchedClause,
				MergeWhenNotMatchedClause, MergeUpdateSpecification,
				MergeInsertSpecification, MergeInsertValueList,
				MergeInsertValueElement, UpdateStatementPositioned,
				UpdateStatementSearched, SetClauseList, SetClause, SetTarget,
				MultipleColumnAssignment, SetTargetList, AssignedRow,
				UpdateTarget, ObjectColumn, MutatedSetClause, MutatedTarget,
				UpdateSource, TemporaryTableDeclaration, FreeLocatorStatement,
				LocatorReference, HoldLocatorStatement, CallStatement,
				ReturnStatement, ReturnValue, StartTransactionStatement,
				TransactionMode, TransactionAccessMode, IsolationLevel,
				LevelOfIsolation, DiagnosticsSize, NumberOfConditions,
				SetTransactionStatement, TransactionCharacteristics,
				SetConstraintsModeStatement, ConstraintNameList,
				SavepointStatement, SavepointSpecifier,
				ReleaseSavepointStatement, CommitStatement, RollbackStatement,
				SavepointClause, ConnectStatement, ConnectionTarget,
				SetConnectionStatement, ConnectionObject, DisconnectStatement,
				DisconnectObject, SetSessionCharacteristicsStatement,
				SessionCharacteristicList, SessionCharacteristic,
				SetSessionUserIdentifierStatement, SetRoleStatement,
				RoleSpecification, SetLocalTimeZoneStatement, SetTimeZoneValue,
				SetCatalogStatement, CatalogNameCharacteristic,
				SetSchemaStatement, SchemaNameCharacteristic,
				SetNamesStatement, CharacterSetNameCharacteristic,
				SetPathStatement, SQLPathCharacteristic,
				SetTransformGroupStatement, TransformGroupCharacteristic,
				SetSessionCollationStatement, CharacterSetSpecificationList,
				CollationSpecification, AllocateDescriptorStatement,
				Occurrences, DeallocateDescriptorStatement,
				GetDescriptorStatement, GetDescriptorInformation,
				GetHeaderInformation, HeaderItemName, GetItemInformation,
				SimpleTargetSpecification1, SimpleTargetSpecification2,
				DescriptorItemName, SetDescriptorStatement,
				SetDescriptorInformation, SetHeaderInformation,
				SetItemInformation, SimpleValueSpecification1,
				SimpleValueSpecification2, ItemNumber, PrepareStatement,
				AttributesSpecification, AttributesVariable,
				SQLStatementVariable, PreparableStatement,
				PreparableSQLDataStatement, PreparableSQLSchemaStatement,
				PreparableSQLTransactionStatement,
				PreparableSQLControlStatement, PreparableSQLSessionStatement,
				DynamicSelectStatement,
				PreparableImplementationDefinedStatement, CursorAttributes,
				CursorAttribute, DeallocatePreparedStatement,
				DescribeStatement, DescribeInputStatement,
				DescribeOutputStatement, NestingOption, UsingDescriptor,
				DescribedObject, InputUsingClause, UsingArguments,
				UsingArgument, UsingInputDescriptor, OutputUsingClause,
				IntoArguments, IntoArgument, IntoDescriptor, ExecuteStatement,
				ResultUsingClause, ParameterUsingClause,
				ExecuteImmediateStatement, DynamicDeclareCursor,
				AllocateCursorStatement, CursorIntent, StatementCursor,
				ResultSetCursor, DynamicOpenStatement, DynamicFetchStatement,
				DynamicSingleRowSelectStatement, DynamicCloseStatement,
				DynamicDeleteStatementPositioned,
				DynamicUpdateStatementPositioned,
				PreparableDynamicDeleteStatementPositioned,
				PreparableDynamicUpdateStatementPositioned,
				EmbeddedSQLHostProgram, EmbeddedSQLStatement,
				StatementOrDeclaration, SQLPrefix, SQLTerminator,
				EmbeddedAuthorizationDeclaration, EmbeddedAuthorizationClause,
				EmbeddedAuthorizationIdentifier, EmbeddedPathSpecification,
				EmbeddedTransformGroupSpecification,
				EmbeddedCollationSpecification, EmbeddedSQLDeclareSection,
				EmbeddedCharacterSetDeclaration, EmbeddedSQLBeginDeclare,
				EmbeddedSQLEndDeclare, EmbeddedSQLMUMPSDeclare,
				HostVariableDefinition, EmbeddedVariableName, HostIdentifier,
				EmbeddedExceptionDeclaration, Condition, SQLCondition,
				MajorCategory, SQLSTATEClassValue, SQLSTATESubclassValue,
				SQLSTATEChar, ConditionAction, GoTo, GotoTarget,
				HostLabelIdentifier, HostPLILabelVariable,
				EmbeddedSQLAdaProgram, AdaVariableDefinition, AdaInitialValue,
				AdaAssignmentOperator, AdaHostIdentifier, AdaTypeSpecification,
				AdaQualifiedTypeSpecification, AdaUnqualifiedTypeSpecification,
				AdaDerivedTypeSpecification, AdaCLOBVariable,
				AdaCLOBLocatorVariable, AdaBLOBVariable,
				AdaBLOBLocatorVariable, AdaUserDefinedTypeVariable,
				AdaUserDefinedTypeLocatorVariable, AdaREFVariable,
				AdaArrayLocatorVariable, AdaMultisetLocatorVariable,
				EmbeddedSQLCProgram, CVariableDefinition,
				CVariableSpecification, CStorageClass, CClassModifier,
				CNumericVariable, CCharacterVariable, CCharacterType,
				CArraySpecification, CHostIdentifier, CDerivedVariable,
				CVARCHARVariable, CNCHARVariable, CNCHARVARYINGVariable,
				CCLOBVariable, CNCLOBVariable, CUserDefinedTypeVariable,
				CBLOBVariable, CCLOBLocatorVariable, CBLOBLocatorVariable,
				CArrayLocatorVariable, CMultisetLocatorVariable,
				CUserDefinedTypeLocatorVariable, CREFVariable, CInitialValue,
				EmbeddedSQLCOBOLProgram, COBOLVariableDefinition,
				COBOLHostIdentifier, COBOLTypeSpecification,
				COBOLDerivedTypeSpecification, COBOLCharacterType,
				COBOLNationalCharacterType, COBOLCLOBVariable,
				COBOLNCLOBVariable, COBOLBLOBVariable,
				COBOLUserDefinedTypeVariable, COBOLCLOBLocatorVariable,
				COBOLBLOBLocatorVariable, COBOLArrayLocatorVariable,
				COBOLMultisetLocatorVariable,
				COBOLUserDefinedTypeLocatorVariable, COBOLREFVariable,
				COBOLNumericType, COBOLNinesSpecification, COBOLIntegerType,
				COBOLBinaryInteger, COBOLNines, EmbeddedSQLFortranProgram,
				FortranVariableDefinition, FortranHostIdentifier,
				FortranTypeSpecification, FortranDerivedTypeSpecification,
				FortranCLOBVariable, FortranBLOBVariable,
				FortranUserDefinedTypeVariable, FortranCLOBLocatorVariable,
				FortranBLOBLocatorVariable,
				FortranUserDefinedTypeLocatorVariable,
				FortranArrayLocatorVariable, FortranMultisetLocatorVariable,
				FortranREFVariable, EmbeddedSQLMUMPSProgram,
				MUMPSVariableDefinition, MUMPSCharacterVariable,
				MUMPSHostIdentifier, MUMPSLengthSpecification,
				MUMPSNumericVariable, MUMPSTypeSpecification,
				MUMPSDerivedTypeSpecification, MUMPSCLOBVariable,
				MUMPSBLOBVariable, MUMPSUserDefinedTypeVariable,
				MUMPSCLOBLocatorVariable, MUMPSBLOBLocatorVariable,
				MUMPSUserDefinedTypeLocatorVariable, MUMPSArrayLocatorVariable,
				MUMPSMultisetLocatorVariable, MUMPSREFVariable,
				EmbeddedSQLPascalProgram, PascalVariableDefinition,
				PascalHostIdentifier, PascalTypeSpecification,
				PascalDerivedTypeSpecification, PascalCLOBVariable,
				PascalBLOBVariable, PascalCLOBLocatorVariable,
				PascalUserDefinedTypeVariable, PascalBLOBLocatorVariable,
				PascalUserDefinedTypeLocatorVariable,
				PascalArrayLocatorVariable, PascalMultisetLocatorVariable,
				PascalREFVariable, EmbeddedSQLPLIProgram,
				PLIVariableDefinition, PLIHostIdentifier, PLITypeSpecification,
				PLIDerivedTypeSpecification, PLICLOBVariable, PLIBLOBVariable,
				PLIUserDefinedTypeVariable, PLICLOBLocatorVariable,
				PLIBLOBLocatorVariable, PLIUserDefinedTypeLocatorVariable,
				PLIArrayLocatorVariable, PLIMultisetLocatorVariable,
				PLIREFVariable, PLITypeFixedDecimal, PLITypeFixedBinary,
				PLITypeFloatBinary, DirectSQLStatement,
				DirectlyExecutableStatement, DirectSQLDataStatement,
				DirectImplementationDefinedStatement,
				DirectSelectStatementMultipleRows, GetDiagnosticsStatement,
				SQLDiagnosticsInformation, StatementInformation,
				StatementInformationItem, StatementInformationItemName,
				ConditionInformation, ConditionNumber,
				ConditionInformationItem, ConditionInformationItemName,
				OverlapsPredicatePart, Query;
